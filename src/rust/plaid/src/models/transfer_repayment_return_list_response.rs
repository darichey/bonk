...
pub struct TransferRepaymentReturnListResponse {
    ...
    pub repayment_returns: Vec<models::TransferRepaymentReturn>,
...
impl TransferRepaymentReturnListResponse {
    ...
    pub fn new(repayment_returns: Vec<models::TransferRepaymentReturn>, request_id: String) -> TransferRepaymentReturnListResponse {
