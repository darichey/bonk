...
pub struct TaxpayerIdentifier {
    ...
    pub taxpayer_identifier_type: Option<models::TaxpayerIdentifierType>,
...
impl TaxpayerIdentifier {
    ...
    pub fn new(taxpayer_identifier_type: Option<models::TaxpayerIdentifierType>, taxpayer_identifier_value: Option<String>) -> TaxpayerIdentifier {
        TaxpayerIdentifier {
