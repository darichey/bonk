...
pub struct Activity {
    ...
    pub activity: models::ActivityType,
    ...
    pub authentication: Option<models::ItemCreateAuthentication>,
}

impl Activity {
    /// Describes a consent activity.
    pub fn new(activity: models::ActivityType, initiated_date: String, id: String, initiator: String, state: models::ActionState) -> Activity {
        Activity {
            activity,
            initiated_date,
            id,
