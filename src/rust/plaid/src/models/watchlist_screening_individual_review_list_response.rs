...
impl WatchlistScreeningIndividualReviewListResponse {
    ...
    pub fn new(watchlist_screening_reviews: Vec<crate::models::WatchlistScreeningReview>, next_cursor: Option<String>, request_id: String) -> WatchlistScreeningIndividualReviewListResponse {
