...
pub struct CraBankIncomeCause {
    ...
    pub error_type: models::CreditBankIncomeErrorType,
...
impl CraBankIncomeCause {
    ...
    pub fn new(error_type: models::CreditBankIncomeErrorType, error_code: String, error_message: String, display_message: String) -> CraBankIncomeCause {
        CraBankIncomeCause {
            error_type,
            error_code,
            error_message,
