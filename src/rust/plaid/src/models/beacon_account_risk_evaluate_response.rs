...
pub struct BeaconAccountRiskEvaluateResponse {
    ...
    pub accounts: Vec<models::BeaconAccountRiskEvaluateAccount>,
}
...
impl BeaconAccountRiskEvaluateResponse {
    ...
    pub fn new(request_id: String, accounts: Vec<models::BeaconAccountRiskEvaluateAccount>) -> BeaconAccountRiskEvaluateResponse {
