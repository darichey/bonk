...
impl TransactionsRemovedWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, removed_transactions: Vec<String>, item_id: String, environment: models::WebhookEnvironmentValues) -> TransactionsRemovedWebhook {
