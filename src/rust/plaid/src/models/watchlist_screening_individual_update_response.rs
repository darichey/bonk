...
impl WatchlistScreeningIndividualUpdateResponse {
    ...
    pub fn new(id: String, search_terms: models::WatchlistScreeningSearchTerms, assignee: Option<String>, status: models::WatchlistScreeningStatus, client_user_id: Option<String>, audit_trail: models::WatchlistScreeningAuditTrail, request_id: String) -> WatchlistScreeningIndividualUpdateResponse {
