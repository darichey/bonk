...
pub struct AccountAssets {
    ...
    pub balances: models::AssetReportAccountBalance,
    ...
    pub investments: Option<models::AssetReportInvestments>,
    ...
    pub ownership_type: Option<Option<models::OwnershipType>>,
