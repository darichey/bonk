...
impl UserAccountRevokedWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, item_id: String, account_id: String, environment: models::WebhookEnvironmentValues) -> UserAccountRevokedWebhook {
