...
impl IdentityVerificationStepUpdatedWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, identity_verification_id: String, environment: models::WebhookEnvironmentValues) -> IdentityVerificationStepUpdatedWebhook {
