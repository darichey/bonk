...
pub struct HoldingsOverride {
    ...
    pub security: Box<models::SecurityOverride>,
}

impl HoldingsOverride {
    /// Specify the holdings on the account.
    pub fn new(institution_price: f64, quantity: f64, currency: String, security: models::SecurityOverride) -> HoldingsOverride {
        HoldingsOverride {
            institution_price,
