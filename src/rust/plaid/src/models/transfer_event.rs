...
pub struct TransferEvent {
    ...
    pub transfer_type: Option<crate::models::OmittableTransferType>,
...
impl TransferEvent {
    ...
    pub fn new(event_id: i32, timestamp: String, event_type: crate::models::TransferEventType, funding_account_id: Option<String>, transfer_id: String, origination_account_id: Option<String>, failure_reason: Option<crate::models::TransferFailure>, sweep_id: Option<String>, sweep_amount: Option<String>, refund_id: Option<String>, originator_client_id: Option<String>) -> TransferEvent {
        TransferEvent {
            event_id,
            timestamp,
            event_type,
