...
pub struct BankTransferEvent {
    ...
    pub event_type: models::BankTransferEventType,
    ...
    pub bank_transfer_type: models::BankTransferType,
...
impl BankTransferEvent {
    ...
    pub fn new(event_id: i32, timestamp: String, event_type: models::BankTransferEventType, account_id: String, bank_transfer_id: String, origination_account_id: Option<String>, bank_transfer_type: models::BankTransferType, bank_transfer_amount: String, bank_transfer_iso_currency_code: String, failure_reason: Option<models::BankTransferFailure>, direction: Option<models::BankTransferDirection>) -> BankTransferEvent {
        BankTransferEvent {
            event_id,
            timestamp,
            event_type,
