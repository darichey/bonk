...
pub struct Transfer {
    ...
    pub sweep_status: Option<Option<models::TransferSweepStatus>>,
    ...
    pub refunds: Vec<models::TransferRefund>,
    ...
    pub expected_sweep_settlement_schedule: Option<Vec<models::TransferExpectedSweepSettlementScheduleItem>>,
