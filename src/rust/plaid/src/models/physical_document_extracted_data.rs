...
impl PhysicalDocumentExtractedData {
    ...
    pub fn new(id_number: Option<String>, category: models::PhysicalDocumentCategory, expiration_date: Option<String>, issuing_country: String, issuing_region: Option<String>, date_of_birth: Option<String>, address: Option<models::IdentityVerificationDocumentAddressResponse>) -> PhysicalDocumentExtractedData {
