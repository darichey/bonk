...
pub struct SandboxBankIncomeFireWebhookRequest {
    ...
    pub webhook_code: models::SandboxBankIncomeWebhookFireRequestWebhookCode,
    #[serde(rename = "webhook_fields")]
    pub webhook_fields: Box<models::SandboxBankIncomeWebhookFireRequestWebhookFields>,
}
...
impl SandboxBankIncomeFireWebhookRequest {
    ...
    pub fn new(webhook_code: models::SandboxBankIncomeWebhookFireRequestWebhookCode, webhook_fields: models::SandboxBankIncomeWebhookFireRequestWebhookFields) -> SandboxBankIncomeFireWebhookRequest {
