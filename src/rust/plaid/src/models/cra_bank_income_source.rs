...
pub struct CraBankIncomeSource {
    ...
    pub forecasted_average_monthly_income_prediction_intervals: Vec<crate::models::CraPredictionInterval>,
...
impl CraBankIncomeSource {
    ...
    pub fn new(forecasted_average_monthly_income_prediction_intervals: Vec<crate::models::CraPredictionInterval>) -> CraBankIncomeSource {
        CraBankIncomeSource {
            account_id: None,
