...
impl ItemAddResultWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, link_session_id: String, link_token: String, public_token: String, environment: crate::models::WebhookEnvironmentValues) -> ItemAddResultWebhook {
