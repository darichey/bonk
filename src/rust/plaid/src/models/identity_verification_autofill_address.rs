...
impl IdentityVerificationAutofillAddress {
    ...
    pub fn new(street: String, street2: Option<String>, city: Option<String>, region: Option<String>, postal_code: Option<String>, country: String, po_box: models::PoBoxStatus, r#type: models::AddressPurposeLabel) -> IdentityVerificationAutofillAddress {
