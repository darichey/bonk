...
pub struct LinkDeliveryCallbackWebhook {
    ...
    pub link_callback_metadata: models::LinkCallbackMetadata,
}

impl LinkDeliveryCallbackWebhook {
    /// Webhook containing metadata proxied over from Link callback e.g `onEvent`, `onExit`, `onSuccess`.
    pub fn new(webhook_type: String, webhook_code: String, link_delivery_session_id: String, timestamp: String, link_callback_metadata: models::LinkCallbackMetadata) -> LinkDeliveryCallbackWebhook {
