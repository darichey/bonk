...
impl InvestmentsTransactionsGetResponse {
    ...
    pub fn new(item: models::Item, accounts: Vec<models::AccountBase>, securities: Vec<models::Security>, investment_transactions: Vec<models::InvestmentTransaction>, total_investment_transactions: i32, request_id: String) -> InvestmentsTransactionsGetResponse {
