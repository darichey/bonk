...
impl WalletTransactionStatusUpdateWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, transaction_id: String, new_status: crate::models::WalletTransactionStatus, old_status: crate::models::WalletTransactionStatus, timestamp: String, environment: crate::models::WebhookEnvironmentValues) -> WalletTransactionStatusUpdateWebhook {
