...
pub struct WatchlistScreeningIndividualListResponse {
    ...
    pub watchlist_screenings: Vec<models::WatchlistScreeningIndividual>,
...
impl WatchlistScreeningIndividualListResponse {
    ...
    pub fn new(watchlist_screenings: Vec<models::WatchlistScreeningIndividual>, next_cursor: Option<String>, request_id: String) -> WatchlistScreeningIndividualListResponse {
