...
impl BeaconReportGetResponse {
    ...
    pub fn new(id: String, beacon_user_id: String, created_at: String, r#type: crate::models::BeaconReportType, fraud_date: Option<String>, event_date: String, fraud_amount: Option<crate::models::FraudAmount>, audit_trail: crate::models::BeaconAuditTrail, request_id: String) -> BeaconReportGetResponse {
