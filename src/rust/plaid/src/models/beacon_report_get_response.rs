...
impl BeaconReportGetResponse {
    ...
    pub fn new(id: String, beacon_user_id: String, created_at: String, r#type: models::BeaconReportType, fraud_date: Option<String>, event_date: String, fraud_amount: Option<models::FraudAmount>, audit_trail: models::BeaconAuditTrail, request_id: String) -> BeaconReportGetResponse {
