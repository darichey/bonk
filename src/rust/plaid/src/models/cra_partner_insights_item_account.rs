...
pub struct CraPartnerInsightsItemAccount {
    ...
    pub metadata: Box<models::CraPartnerInsightsItemAccountMetadata>,
...
impl CraPartnerInsightsItemAccount {
    ...
    pub fn new(mask: Option<String>, metadata: models::CraPartnerInsightsItemAccountMetadata, name: String, official_name: Option<String>, subtype: models::DepositoryAccountSubtype, r#type: models::CreditBankIncomeAccountType, owners: Vec<models::Owner>) -> CraPartnerInsightsItemAccount {
