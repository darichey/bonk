...
pub struct BeaconUserHistoryListResponse {
    ...
    pub beacon_users: Vec<models::BeaconUser>,
...
impl BeaconUserHistoryListResponse {
    ...
    pub fn new(beacon_users: Vec<models::BeaconUser>, next_cursor: Option<String>, request_id: String) -> BeaconUserHistoryListResponse {
