...
pub struct PaymentInitiationPaymentReverseRequest {
    ...
    pub amount: Option<Box<models::PaymentAmountToRefund>>,
    /// The counterparty's birthdate, in [ISO 8601](https://wikipedia.org/wiki/ISO_8601) (YYYY-MM-DD) format.
    #[serde(rename = "counterparty_date_of_birth", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub counterparty_date_of_birth: Option<Option<String>>,
    #[serde(rename = "counterparty_address", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub counterparty_address: Option<Option<models::PaymentInitiationAddress>>,
}
