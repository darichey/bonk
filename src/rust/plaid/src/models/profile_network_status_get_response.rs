...
pub struct ProfileNetworkStatusGetResponse {
    ...
    pub network_status: crate::models::ProfileNetworkStatusGetNetworkStatus,
...
impl ProfileNetworkStatusGetResponse {
    ...
    pub fn new(network_status: crate::models::ProfileNetworkStatusGetNetworkStatus, request_id: String) -> ProfileNetworkStatusGetResponse {
