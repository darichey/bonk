...
pub struct MonitoringIncomeSource {
    ...
    pub income_category: models::CreditBankIncomeCategory,
...
impl MonitoringIncomeSource {
    ...
    pub fn new(income_source_id: String, income_description: String, income_category: models::CreditBankIncomeCategory, last_transaction_date: String) -> MonitoringIncomeSource {
