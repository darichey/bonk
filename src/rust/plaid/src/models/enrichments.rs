...
pub struct Enrichments {
    ...
    pub personal_finance_category: Option<models::PersonalFinanceCategory>,
    ...
    pub recurrence: Option<Option<models::Recurrence>>,
...
impl Enrichments {
    ...
    pub fn new(counterparties: Vec<models::Counterparty>, location: models::Location, logo_url: Option<String>, merchant_name: Option<String>, payment_channel: models::PaymentChannel, phone_number: Option<String>, personal_finance_category: Option<models::PersonalFinanceCategory>, personal_finance_category_icon_url: String, website: Option<String>) -> Enrichments {
        Enrichments {
            check_number: None,
            counterparties,
            entity_id: None,
