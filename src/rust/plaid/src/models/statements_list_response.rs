...
pub struct StatementsListResponse {
    ...
    pub accounts: Vec<crate::models::StatementsAccount>,
...
impl StatementsListResponse {
    ...
    pub fn new(accounts: Vec<crate::models::StatementsAccount>, institution_id: String, institution_name: String, item_id: String, request_id: String) -> StatementsListResponse {
