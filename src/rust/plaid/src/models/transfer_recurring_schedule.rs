...
impl TransferRecurringSchedule {
    ...
    pub fn new(interval_unit: crate::models::TransferScheduleIntervalUnit, interval_count: i32, interval_execution_day: i32, start_date: String) -> TransferRecurringSchedule {
