...
impl RecurringTransactionsUpdateWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, item_id: String, account_ids: Vec<String>, environment: models::WebhookEnvironmentValues) -> RecurringTransactionsUpdateWebhook {
