...
pub struct LinkDeliveryGetResponse {
    #[serde(rename = "status")]
    pub status: models::LinkDeliverySessionStatus,
...
impl LinkDeliveryGetResponse {
    ...
    pub fn new(status: models::LinkDeliverySessionStatus, created_at: String, request_id: String) -> LinkDeliveryGetResponse {
