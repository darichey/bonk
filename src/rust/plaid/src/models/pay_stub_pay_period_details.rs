...
pub struct PayStubPayPeriodDetails {
    ...
    pub distribution_breakdown: Vec<models::PayStubDistributionBreakdown>,
    ...
    pub pay_basis: Option<models::CreditPayStubPayBasisType>,
...
impl PayStubPayPeriodDetails {
    ...
    pub fn new(pay_amount: Option<f64>, distribution_breakdown: Vec<models::PayStubDistributionBreakdown>, end_date: Option<String>, gross_earnings: Option<f64>, iso_currency_code: Option<String>, pay_date: Option<String>, pay_frequency: Option<String>, start_date: Option<String>, unofficial_currency_code: Option<String>) -> PayStubPayPeriodDetails {
