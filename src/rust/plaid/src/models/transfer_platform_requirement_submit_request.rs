...
pub struct TransferPlatformRequirementSubmitRequest {
    ...
    pub requirement_submissions: Vec<crate::models::TransferPlatformRequirementSubmission>,
}

impl TransferPlatformRequirementSubmitRequest {
    /// Defines the request schema for `/transfer/platform/requirement/submit`
    pub fn new(originator_client_id: String, requirement_submissions: Vec<crate::models::TransferPlatformRequirementSubmission>) -> TransferPlatformRequirementSubmitRequest {
