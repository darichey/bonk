...
pub struct DocumentRiskSignal {
    ...
    pub institution_metadata: Option<models::DocumentRiskSignalInstitutionMetadata>,
...
impl DocumentRiskSignal {
    ...
    pub fn new(r#type: Option<String>, field: Option<String>, has_fraud_risk: Option<bool>, institution_metadata: Option<models::DocumentRiskSignalInstitutionMetadata>, expected_value: Option<String>, actual_value: Option<String>, signal_description: Option<String>, page_number: Option<i32>) -> DocumentRiskSignal {
        DocumentRiskSignal {
            r#type,
            field,
            has_fraud_risk,
