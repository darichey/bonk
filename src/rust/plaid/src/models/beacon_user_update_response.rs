...
impl BeaconUserUpdateResponse {
    ...
    pub fn new(id: String, created_at: String, updated_at: String, status: crate::models::BeaconUserStatus, program_id: String, client_user_id: String, user: crate::models::BeaconUserData, audit_trail: crate::models::BeaconAuditTrail, request_id: String) -> BeaconUserUpdateResponse {
