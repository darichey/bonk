...
impl BeaconUserUpdateResponse {
    ...
    pub fn new(item_ids: Vec<String>, id: String, version: i32, created_at: String, updated_at: String, status: models::BeaconUserStatus, program_id: String, client_user_id: String, user: models::BeaconUserData, audit_trail: models::BeaconAuditTrail, request_id: String) -> BeaconUserUpdateResponse {
