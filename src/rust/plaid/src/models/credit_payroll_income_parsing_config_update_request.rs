...
pub struct CreditPayrollIncomeParsingConfigUpdateRequest {
    ...
    pub parsing_config: Vec<models::IncomeVerificationDocParsingConfig>,
}
...
impl CreditPayrollIncomeParsingConfigUpdateRequest {
    ...
    pub fn new(user_token: String, parsing_config: Vec<models::IncomeVerificationDocParsingConfig>) -> CreditPayrollIncomeParsingConfigUpdateRequest {
