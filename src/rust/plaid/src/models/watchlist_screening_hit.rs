...
pub struct WatchlistScreeningHit {
    ...
    pub list_code: models::IndividualWatchlistCode,
    ...
    pub analysis: Option<models::ScreeningHitAnalysis>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<models::ScreeningHitData>,
}

impl WatchlistScreeningHit {
    /// Data from a government watchlist or PEP list that has been attached to the screening.
    pub fn new(id: String, review_status: models::WatchlistScreeningHitStatus, first_active: String, inactive_since: Option<String>, historical_since: Option<String>, list_code: models::IndividualWatchlistCode, plaid_uid: String, source_uid: Option<String>) -> WatchlistScreeningHit {
