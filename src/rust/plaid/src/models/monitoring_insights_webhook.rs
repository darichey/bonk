...
pub struct MonitoringInsightsWebhook {
    ...
    #[serde(rename = "status")]
    pub status: crate::models::MonitoringInsightsStatus,
...
impl MonitoringInsightsWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, status: crate::models::MonitoringInsightsStatus, user_id: String, environment: crate::models::WebhookEnvironmentValues) -> MonitoringInsightsWebhook {
