...
impl ProcessorDefaultUpdateWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, new_transactions: f64, account_id: String, environment: models::WebhookEnvironmentValues) -> ProcessorDefaultUpdateWebhook {
