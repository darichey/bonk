...
pub struct WatchlistScreeningIndividualProgramGetResponse {
    ...
    pub lists_enabled: Vec<models::IndividualWatchlistCode>,
    ...
    pub name_sensitivity: models::ProgramNameSensitivity,
...
impl WatchlistScreeningIndividualProgramGetResponse {
    ...
    pub fn new(id: String, created_at: String, is_rescanning_enabled: bool, lists_enabled: Vec<models::IndividualWatchlistCode>, name: String, name_sensitivity: models::ProgramNameSensitivity, audit_trail: models::WatchlistScreeningAuditTrail, is_archived: bool, request_id: String) -> WatchlistScreeningIndividualProgramGetResponse {
        WatchlistScreeningIndividualProgramGetResponse {
            id,
            created_at,
