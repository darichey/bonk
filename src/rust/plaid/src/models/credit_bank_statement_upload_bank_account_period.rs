...
impl CreditBankStatementUploadBankAccountPeriod {
    ...
    pub fn new(start_date: Option<String>, end_date: Option<String>, starting_balance: Option<f64>, ending_balance: Option<f64>) -> CreditBankStatementUploadBankAccountPeriod {
