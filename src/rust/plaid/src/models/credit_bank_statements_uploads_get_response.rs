...
pub struct CreditBankStatementsUploadsGetResponse {
    ...
    #[serde(rename = "items")]
    pub items: Vec<models::CreditBankStatementUploadItem>,
...
impl CreditBankStatementsUploadsGetResponse {
    ...
    pub fn new(items: Vec<models::CreditBankStatementUploadItem>, request_id: String) -> CreditBankStatementsUploadsGetResponse {
