...
pub struct CraBankIncomeItem {
    ...
    pub bank_income_accounts: Vec<crate::models::CraBankIncomeAccount>,
    /// The income sources for this Item. Each entry in the array is a single income source.
    #[serde(rename = "bank_income_sources")]
    pub bank_income_sources: Vec<crate::models::CraBankIncomeSource>,
...
impl CraBankIncomeItem {
    ...
    pub fn new(bank_income_accounts: Vec<crate::models::CraBankIncomeAccount>, bank_income_sources: Vec<crate::models::CraBankIncomeSource>) -> CraBankIncomeItem {
        CraBankIncomeItem {
            item_id: None,
