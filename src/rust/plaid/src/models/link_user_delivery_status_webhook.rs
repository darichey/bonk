...
pub struct LinkUserDeliveryStatusWebhook {
    ...
    pub link_delivery_metadata: models::LinkDeliveryMetadata,
}
...
impl LinkUserDeliveryStatusWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, link_delivery_session_id: String, timestamp: String, link_delivery_metadata: models::LinkDeliveryMetadata) -> LinkUserDeliveryStatusWebhook {
