...
pub struct TransferAuthorizationPaymentRisk {
    ...
    pub risk_level: Option<models::TransferAuthorizationRiskLevel>,
...
impl TransferAuthorizationPaymentRisk {
    ...
    pub fn new(bank_initiated_return_score: Option<i32>, customer_initiated_return_score: Option<i32>, risk_level: Option<models::TransferAuthorizationRiskLevel>, warnings: Vec<models::SignalWarning>) -> TransferAuthorizationPaymentRisk {
