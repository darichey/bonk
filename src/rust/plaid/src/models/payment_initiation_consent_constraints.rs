...
pub struct PaymentInitiationConsentConstraints {
    ...
    pub valid_date_time: Option<Option<Box<models::PaymentConsentValidDateTime>>>,
    #[serde(rename = "max_payment_amount")]
    pub max_payment_amount: Box<models::PaymentConsentMaxPaymentAmount>,
    /// A list of amount limitations per period of time.
    #[serde(rename = "periodic_amounts")]
    pub periodic_amounts: Vec<models::PaymentConsentPeriodicAmount>,
}

impl PaymentInitiationConsentConstraints {
    /// Limitations that will be applied to payments initiated using the payment consent.
    pub fn new(max_payment_amount: models::PaymentConsentMaxPaymentAmount, periodic_amounts: Vec<models::PaymentConsentPeriodicAmount>) -> PaymentInitiationConsentConstraints {
