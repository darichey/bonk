...
impl CreditBankIncomeCause {
    ...
    pub fn new(error_type: models::CreditBankIncomeErrorType, error_code: String, error_message: String, display_message: String, item_id: String) -> CreditBankIncomeCause {
