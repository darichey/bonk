...
impl CreditCardLiability {
    ...
    pub fn new(account_id: Option<String>, aprs: Vec<models::Apr>, is_overdue: Option<bool>, last_payment_amount: Option<f64>, last_payment_date: Option<String>, last_statement_issue_date: Option<String>, last_statement_balance: Option<f64>, minimum_payment_amount: Option<f64>, next_payment_due_date: Option<String>) -> CreditCardLiability {
        CreditCardLiability {
            account_id,
            aprs,
            is_overdue,
