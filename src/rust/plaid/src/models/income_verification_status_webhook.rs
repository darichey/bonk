...
impl IncomeVerificationStatusWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, item_id: String, verification_status: String, environment: models::WebhookEnvironmentValues) -> IncomeVerificationStatusWebhook {
