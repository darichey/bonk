...
impl ToString for ConsentEventType {
    fn to_string(&self) -> String {
        match self {
            Self::Granted => String::from("CONSENT_GRANTED"),
            Self::Revoked => String::from("CONSENT_REVOKED"),
            Self::Updated => String::from("CONSENT_UPDATED"),
        }
    }
}
