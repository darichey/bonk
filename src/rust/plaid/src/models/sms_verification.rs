...
pub struct SmsVerification {
    #[serde(rename = "status")]
    pub status: crate::models::SmsVerificationStatus,
...
impl SmsVerification {
    ...
    pub fn new(status: crate::models::SmsVerificationStatus, attempt: i32, phone_number: Option<String>, delivery_attempt_count: i32, solve_attempt_count: i32, initially_sent_at: Option<String>, last_sent_at: Option<String>, redacted_at: Option<String>) -> SmsVerification {
        SmsVerification {
            status,
            attempt,
            phone_number,
