...
impl std::fmt::Display for TransactionsUpdateStatus {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::TransactionsUpdateStatusUnknown => write!(f, "TRANSACTIONS_UPDATE_STATUS_UNKNOWN"),
            Self::NotReady => write!(f, "NOT_READY"),
            Self::InitialUpdateComplete => write!(f, "INITIAL_UPDATE_COMPLETE"),
            Self::HistoricalUpdateComplete => write!(f, "HISTORICAL_UPDATE_COMPLETE"),
        }
    }
}
