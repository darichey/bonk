...
impl PartnerCustomerCreateRequest {
    ...
    pub fn new(company_name: String, is_diligence_attested: bool, legal_entity_name: String, website: String, application_name: String, address: crate::models::PartnerEndCustomerAddress, is_bank_addendum_completed: bool) -> PartnerCustomerCreateRequest {
