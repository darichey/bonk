...
pub struct BeaconAccountRiskEvaluateRequest {
    ...
    pub options: Option<Box<crate::models::BeaconAccountRiskEvaluateRequestOptions>>,
    ...
    pub evaluation_reason: Option<crate::models::BeaconAccountRiskEvaluateEvaluationReason>,
