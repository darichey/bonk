...
pub struct RecurringInsightsStream {
    ...
    pub frequency: Option<models::RecurringTransactionFrequency>,
    ...
    pub average_amount: Option<models::TransactionStreamAmount>,
    #[serde(rename = "newest_transaction_amount", skip_serializing_if = "Option::is_none")]
    pub newest_transaction_amount: Option<models::TransactionStreamAmount>,
    /// Indicates whether the transaction stream is still live.
    #[serde(rename = "is_active")]
    pub is_active: bool,
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<models::TransactionStreamStatus>,
