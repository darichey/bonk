...
pub struct WatchlistScreeningIndividualHitListResponse {
    ...
    pub watchlist_screening_hits: Vec<models::WatchlistScreeningHit>,
...
impl WatchlistScreeningIndividualHitListResponse {
    ...
    pub fn new(watchlist_screening_hits: Vec<models::WatchlistScreeningHit>, next_cursor: Option<String>, request_id: String) -> WatchlistScreeningIndividualHitListResponse {
