...
impl EntityWatchlistScreening {
    ...
    pub fn new(id: String, search_terms: models::EntityWatchlistScreeningSearchTerms, assignee: Option<String>, status: models::WatchlistScreeningStatus, client_user_id: Option<String>, audit_trail: models::WatchlistScreeningAuditTrail) -> EntityWatchlistScreening {
