...
pub struct BaseReportAccount {
    ...
    pub balances: Box<models::BaseReportAccountBalances>,
    ...
    pub metadata: Box<models::BaseReportAccountMetadata>,
    ...
    pub transactions: Vec<models::BaseReportTransaction>,
    ...
    pub historical_balances: Option<Vec<models::BaseReportHistoricalBalance>>,
    #[serde(rename = "account_insights", skip_serializing_if = "Option::is_none")]
    pub account_insights: Option<models::BaseReportAccountInsights>,
    #[serde(rename = "attributes", skip_serializing_if = "Option::is_none")]
    pub attributes: Option<models::BaseReportAttributes>,
}

impl BaseReportAccount {
    /// Base Report information about an account
    pub fn new(account_id: String, balances: models::BaseReportAccountBalances, consumer_disputes: Vec<models::ConsumerDispute>, mask: Option<String>, metadata: models::BaseReportAccountMetadata, name: String, official_name: Option<String>, r#type: models::AccountType, subtype: Option<models::AccountSubtype>, days_available: f64, transactions: Vec<models::BaseReportTransaction>, owners: Vec<models::Owner>, ownership_type: Option<models::OwnershipType>) -> BaseReportAccount {
        BaseReportAccount {
            account_id,
