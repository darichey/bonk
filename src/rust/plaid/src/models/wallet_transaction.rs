...
pub struct WalletTransaction {
    ...
    pub related_transactions: Option<Vec<crate::models::WalletTransactionRelation>>,
}

impl WalletTransaction {
    /// The transaction details
    pub fn new(transaction_id: String, wallet_id: String, reference: String, r#type: RHashType, amount: crate::models::WalletTransactionAmount, counterparty: crate::models::WalletTransactionCounterparty, status: crate::models::WalletTransactionStatus, created_at: String, last_status_update: String) -> WalletTransaction {
        WalletTransaction {
            transaction_id,
            wallet_id,
            reference,
