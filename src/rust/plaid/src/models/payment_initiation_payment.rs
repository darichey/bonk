...
impl PaymentInitiationPayment {
    ...
    pub fn new(payment_id: String, amount: models::PaymentAmount, status: models::PaymentInitiationPaymentStatus, recipient_id: String, reference: String, last_status_update: String, bacs: Option<models::SenderBacsNullable>, iban: Option<String>) -> PaymentInitiationPayment {
