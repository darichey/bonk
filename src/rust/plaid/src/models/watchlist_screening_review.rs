...
impl WatchlistScreeningReview {
    ...
    pub fn new(id: String, confirmed_hits: Vec<String>, dismissed_hits: Vec<String>, comment: Option<String>, audit_trail: crate::models::WatchlistScreeningAuditTrail) -> WatchlistScreeningReview {
