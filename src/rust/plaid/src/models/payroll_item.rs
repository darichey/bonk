...
pub struct PayrollItem {
    ...
    pub accounts: Vec<models::PayrollIncomeAccountData>,
    #[serde(rename = "payroll_income")]
    pub payroll_income: Vec<models::PayrollIncomeObject>,
...
impl PayrollItem {
    ...
    pub fn new(item_id: String, institution_id: String, institution_name: String, accounts: Vec<models::PayrollIncomeAccountData>, payroll_income: Vec<models::PayrollIncomeObject>, status: Option<models::PayrollItemStatus>, updated_at: Option<String>) -> PayrollItem {
        PayrollItem {
            item_id,
            institution_id,
            institution_name,
