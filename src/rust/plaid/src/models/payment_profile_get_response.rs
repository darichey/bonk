...
impl PaymentProfileGetResponse {
    ...
    pub fn new(updated_at: String, created_at: String, deleted_at: Option<String>, status: crate::models::PaymentProfileStatus, request_id: String) -> PaymentProfileGetResponse {
