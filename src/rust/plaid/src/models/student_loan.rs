...
impl StudentLoan {
    ...
    pub fn new(account_id: Option<String>, account_number: Option<String>, disbursement_dates: Option<Vec<String>>, expected_payoff_date: Option<String>, guarantor: Option<String>, interest_rate_percentage: f64, is_overdue: Option<bool>, last_payment_amount: Option<f64>, last_payment_date: Option<String>, last_statement_issue_date: Option<String>, loan_name: Option<String>, loan_status: models::StudentLoanStatus, minimum_payment_amount: Option<f64>, next_payment_due_date: Option<String>, origination_date: Option<String>, origination_principal_amount: Option<f64>, outstanding_interest_amount: Option<f64>, payment_reference_number: Option<String>, pslf_status: models::PslfStatus, repayment_plan: models::StudentRepaymentPlan, sequence_number: Option<String>, servicer_address: models::ServicerAddressData, ytd_interest_paid: Option<f64>, ytd_principal_paid: Option<f64>) -> StudentLoan {
        StudentLoan {
            account_id,
            account_number,
            disbursement_dates,
