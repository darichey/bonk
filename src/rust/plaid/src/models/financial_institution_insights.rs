...
pub struct FinancialInstitutionInsights {
    ...
    pub detected_accounts: Vec<models::DetectedAccount>,
}
...
impl FinancialInstitutionInsights {
    ...
    pub fn new(name: String, website: Option<String>, detected_accounts: Vec<models::DetectedAccount>) -> FinancialInstitutionInsights {
