...
impl PayStubEarningsBreakdown {
    ...
    pub fn new(canonical_description: Option<String>, current_amount: Option<f64>, description: Option<String>, hours: Option<f64>, iso_currency_code: Option<String>, rate: Option<f64>, unofficial_currency_code: Option<String>, ytd_amount: Option<f64>) -> PayStubEarningsBreakdown {
