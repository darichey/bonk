...
pub struct TransactionsRecurringCreateResponse {
    ...
    pub added_streams: Vec<models::TransactionStream>,
    ...
    pub modified_streams: Option<Vec<models::TransactionStream>>,
...
impl TransactionsRecurringCreateResponse {
    ...
    pub fn new(added_streams: Vec<models::TransactionStream>) -> TransactionsRecurringCreateResponse {
