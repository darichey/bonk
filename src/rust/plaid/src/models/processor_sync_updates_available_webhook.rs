...
impl ProcessorSyncUpdatesAvailableWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, account_id: String, initial_update_complete: bool, historical_update_complete: bool, environment: models::WebhookEnvironmentValues) -> ProcessorSyncUpdatesAvailableWebhook {
