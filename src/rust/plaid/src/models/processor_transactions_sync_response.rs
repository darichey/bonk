...
impl ProcessorTransactionsSyncResponse {
    ...
    pub fn new(transactions_update_status: crate::models::TransactionsUpdateStatus, account: crate::models::AccountBase, added: Vec<crate::models::Transaction>, modified: Vec<crate::models::Transaction>, removed: Vec<crate::models::RemovedTransaction>, next_cursor: String, has_more: bool, request_id: String) -> ProcessorTransactionsSyncResponse {
        ProcessorTransactionsSyncResponse {
