...
pub struct BeaconUserData {
    ...
    pub address: models::BeaconUserAddress,
    ...
    pub id_number: Option<models::BeaconUserIdNumber>,
    /// An IPv4 or IPV6 address.
    #[serde(rename = "ip_address", deserialize_with = "Option::deserialize")]
    pub ip_address: Option<String>,
    #[serde(rename = "depository_accounts")]
    pub depository_accounts: Vec<models::BeaconUserDepositoryAccount>,
}

impl BeaconUserData {
    /// A Beacon User's data and resulting analysis when checked against duplicate records and the Beacon Fraud Network.
    pub fn new(date_of_birth: String, name: models::BeaconUserName, address: models::BeaconUserAddress, email_address: Option<String>, phone_number: Option<String>, id_number: Option<models::BeaconUserIdNumber>, ip_address: Option<String>, depository_accounts: Vec<models::BeaconUserDepositoryAccount>) -> BeaconUserData {
        BeaconUserData {
            date_of_birth,
            name,
            address,
