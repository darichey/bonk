...
pub struct UserCustomPassword {
    ...
    pub override_accounts: Vec<models::OverrideAccounts>,
    #[serde(rename = "mfa")]
    pub mfa: models::Mfa,
...
impl UserCustomPassword {
    ...
    pub fn new(seed: String, override_accounts: Vec<models::OverrideAccounts>, mfa: models::Mfa, recaptcha: String, force_error: String) -> UserCustomPassword {
        UserCustomPassword {
            version: None,
            seed,
            override_accounts,
