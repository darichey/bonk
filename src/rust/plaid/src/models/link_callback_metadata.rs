...
pub struct LinkCallbackMetadata {
    ...
    pub callback_type: Option<models::LinkDeliveryWebhookCallbackType>,
    #[serde(rename = "event_name", skip_serializing_if = "Option::is_none")]
    pub event_name: Option<models::LinkEventName>,
    ...
    pub institution: Option<models::LinkDeliveryInstitution>,
    ...
    pub accounts: Option<Vec<models::LinkDeliveryAccount>>,
}
