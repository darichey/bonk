...
impl SelfieCheck {
    ...
    pub fn new(status: models::SelfieCheckStatus, selfies: Vec<models::SelfieCheckSelfie>) -> SelfieCheck {
        SelfieCheck {
            status,
            selfies,
        }
