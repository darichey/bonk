...
pub struct IncomeVerificationTaxformsGetResponse {
    ...
    pub document_metadata: Vec<models::DocumentMetadata>,
    /// A list of forms.
    #[serde(rename = "taxforms")]
    pub taxforms: Vec<models::Taxform>,
...
impl IncomeVerificationTaxformsGetResponse {
    ...
    pub fn new(document_metadata: Vec<models::DocumentMetadata>, taxforms: Vec<models::Taxform>) -> IncomeVerificationTaxformsGetResponse {
