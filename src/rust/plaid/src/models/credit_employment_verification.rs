...
impl CreditEmploymentVerification {
    ...
    pub fn new(account_id: Option<String>, status: Option<String>, start_date: Option<String>, end_date: Option<String>, employer: models::CreditEmployerVerification, title: Option<String>, platform_ids: models::CreditPlatformIds, employee_type: Option<String>, last_paystub_date: Option<String>) -> CreditEmploymentVerification {
