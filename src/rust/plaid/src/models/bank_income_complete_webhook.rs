...
pub struct BankIncomeCompleteWebhook {
    ...
    pub user_id: String,
    #[serde(rename = "result")]
    pub result: models::BankIncomeCompleteResult,
...
impl BankIncomeCompleteWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, user_id: String, result: models::BankIncomeCompleteResult, environment: models::WebhookEnvironmentValues) -> BankIncomeCompleteWebhook {
