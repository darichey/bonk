...
pub struct AccountIdentityDocumentUpload {
    ...
    pub documents: Option<Option<Vec<models::IdentityDocumentUpload>>>,
}

impl AccountIdentityDocumentUpload {
    /// Identity information about an account
    pub fn new(account_id: String, balances: models::AccountBalance, mask: Option<String>, name: String, official_name: Option<String>, r#type: models::AccountType, subtype: Option<models::AccountSubtype>, owners: Vec<models::Owner>) -> AccountIdentityDocumentUpload {
