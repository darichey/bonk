...
pub struct ItemActivityListResponse {
    ...
    pub last_data_access_times: Vec<models::LastDataAccessTimes>,
...
impl ItemActivityListResponse {
    ...
    pub fn new(request_id: String, activities: Vec<models::Activity>, last_data_access_times: Vec<models::LastDataAccessTimes>) -> ItemActivityListResponse {
