...
pub struct W2 {
    ...
    pub employer: Option<models::PaystubEmployer>,
    #[serde(rename = "employee", skip_serializing_if = "Option::is_none")]
    pub employee: Option<models::Employee>,
    ...
    pub box_12: Option<Vec<models::W2Box12>>,
    /// Statutory employee.
    ...
    pub state_and_local_wages: Option<Vec<models::W2StateAndLocalWages>>,
}
