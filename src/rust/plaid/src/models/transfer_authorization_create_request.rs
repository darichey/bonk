...
pub struct TransferAuthorizationCreateRequest {
    ...
    #[serde(rename = "user")]
    pub user: Box<crate::models::TransferAuthorizationUserInRequest>,
    ...
    pub credit_funds_source: Option<Option<crate::models::TransferCreditFundsSource>>,
...
impl TransferAuthorizationCreateRequest {
    ...
    pub fn new(access_token: String, account_id: String, r#type: crate::models::TransferType, network: crate::models::TransferNetwork, amount: String, user: crate::models::TransferAuthorizationUserInRequest) -> TransferAuthorizationCreateRequest {
