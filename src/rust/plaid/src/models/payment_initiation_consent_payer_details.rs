...
pub struct PaymentInitiationConsentPayerDetails {
    ...
    pub numbers: models::PaymentInitiationConsentPayerNumbers,
...
impl PaymentInitiationConsentPayerDetails {
    ...
    pub fn new(name: String, numbers: models::PaymentInitiationConsentPayerNumbers) -> PaymentInitiationConsentPayerDetails {
