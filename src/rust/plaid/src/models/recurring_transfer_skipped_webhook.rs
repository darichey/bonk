...
pub struct RecurringTransferSkippedWebhook {
    ...
    pub authorization_decision: models::TransferAuthorizationDecision,
    #[serde(rename = "authorization_decision_rationale_code", skip_serializing_if = "Option::is_none")]
    pub authorization_decision_rationale_code: Option<models::TransferAuthorizationDecisionRationaleCode>,
...
impl RecurringTransferSkippedWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, recurring_transfer_id: String, authorization_decision: models::TransferAuthorizationDecision, skipped_origination_date: String, environment: models::WebhookEnvironmentValues) -> RecurringTransferSkippedWebhook {
