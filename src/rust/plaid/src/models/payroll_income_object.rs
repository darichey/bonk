...
pub struct PayrollIncomeObject {
    ...
    pub pay_stubs: Vec<models::CreditPayStub>,
    /// Array of tax form W-2s.
    #[serde(rename = "w2s")]
    pub w2s: Vec<models::CreditW2>,
    /// Array of tax form 1099s.
    #[serde(rename = "form1099s")]
    pub form1099s: Vec<models::Credit1099>,
}

impl PayrollIncomeObject {
    /// An object representing payroll data.
    pub fn new(account_id: Option<String>, pay_stubs: Vec<models::CreditPayStub>, w2s: Vec<models::CreditW2>, form1099s: Vec<models::Credit1099>) -> PayrollIncomeObject {
        PayrollIncomeObject {
            account_id,
            pay_stubs,
            w2s,
