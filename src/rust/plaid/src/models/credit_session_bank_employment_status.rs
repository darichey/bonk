...
impl std::fmt::Display for CreditSessionBankEmploymentStatus {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::Approved => write!(f, "APPROVED"),
            Self::NoEmployersFound => write!(f, "NO_EMPLOYERS_FOUND"),
            Self::EmployerNotListed => write!(f, "EMPLOYER_NOT_LISTED"),
        }
    }
}
