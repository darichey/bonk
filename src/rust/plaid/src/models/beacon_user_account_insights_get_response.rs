...
pub struct BeaconUserAccountInsightsGetResponse {
    ...
    pub bank_account_insights: models::BeaconBankAccounts,
...
impl BeaconUserAccountInsightsGetResponse {
    ...
    pub fn new(beacon_user_id: String, created_at: String, updated_at: String, bank_account_insights: models::BeaconBankAccounts, request_id: String) -> BeaconUserAccountInsightsGetResponse {
