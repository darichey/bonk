...
pub struct WatchlistScreeningIndividualCreateRequest {
    ...
    pub search_terms: Box<models::WatchlistScreeningRequestSearchTerms>,
...
impl WatchlistScreeningIndividualCreateRequest {
    ...
    pub fn new(search_terms: models::WatchlistScreeningRequestSearchTerms) -> WatchlistScreeningIndividualCreateRequest {
