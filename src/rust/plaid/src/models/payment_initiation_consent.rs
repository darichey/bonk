...
impl PaymentInitiationConsent {
    ...
    pub fn new(consent_id: String, status: models::PaymentInitiationConsentStatus, created_at: String, recipient_id: String, reference: String, constraints: models::PaymentInitiationConsentConstraints, scopes: Vec<models::PaymentInitiationConsentScope>) -> PaymentInitiationConsent {
