...
pub struct PayrollIncomeAccountData {
    ...
    pub rate_of_pay: models::PayrollIncomeRateOfPay,
...
impl PayrollIncomeAccountData {
    ...
    pub fn new(account_id: Option<String>, rate_of_pay: models::PayrollIncomeRateOfPay, pay_frequency: Option<String>) -> PayrollIncomeAccountData {
