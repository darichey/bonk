...
pub struct StatementsAccount {
    ...
    pub statements: Vec<models::StatementsStatement>,
}

impl StatementsAccount {
    /// Account associated with the Item.
    pub fn new(account_id: String, account_mask: String, account_name: String, account_official_name: String, account_subtype: String, account_type: String, statements: Vec<models::StatementsStatement>) -> StatementsAccount {
        StatementsAccount {
            account_id,
            account_mask,
            account_name,
