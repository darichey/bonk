...
pub struct TransactionsEnrichRequest {
    ...
    pub transactions: Vec<models::ClientProvidedTransaction>,
    #[serde(rename = "options", skip_serializing_if = "Option::is_none")]
    pub options: Option<Box<models::TransactionsEnrichRequestOptions>>,
}

impl TransactionsEnrichRequest {
    /// TransactionsEnrichRequest defines the request schema for `/transactions/enrich`.
    pub fn new(account_type: String, transactions: Vec<models::ClientProvidedTransaction>) -> TransactionsEnrichRequest {
