...
impl MortgageLiability {
    ...
    pub fn new(account_id: String, account_number: String, current_late_fee: Option<f64>, escrow_balance: Option<f64>, has_pmi: Option<bool>, has_prepayment_penalty: Option<bool>, interest_rate: models::MortgageInterestRate, last_payment_amount: Option<f64>, last_payment_date: Option<String>, loan_type_description: Option<String>, loan_term: Option<String>, maturity_date: Option<String>, next_monthly_payment: Option<f64>, next_payment_due_date: Option<String>, origination_date: Option<String>, origination_principal_amount: Option<f64>, past_due_amount: Option<f64>, property_address: models::MortgagePropertyAddress, ytd_interest_paid: Option<f64>, ytd_principal_paid: Option<f64>) -> MortgageLiability {
        MortgageLiability {
            account_id,
            account_number,
            current_late_fee,
