...
impl BeaconDuplicateDetectedWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, beacon_duplicate_id: String, environment: models::WebhookEnvironmentValues) -> BeaconDuplicateDetectedWebhook {
