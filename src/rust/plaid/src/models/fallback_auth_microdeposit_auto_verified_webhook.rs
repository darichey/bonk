...
impl FallbackAuthMicrodepositAutoVerifiedWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, account_id: String, item_id: String, environment: models::WebhookEnvironmentValues) -> FallbackAuthMicrodepositAutoVerifiedWebhook {
