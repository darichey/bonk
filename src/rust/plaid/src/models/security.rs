...
pub struct Security {
    ...
    pub option_contract: Option<crate::models::OptionContract>,
}

impl Security {
    /// Contains details about a security
    pub fn new(security_id: String, isin: Option<String>, cusip: Option<String>, sedol: Option<String>, institution_security_id: Option<String>, institution_id: Option<String>, proxy_security_id: Option<String>, name: Option<String>, ticker_symbol: Option<String>, is_cash_equivalent: Option<bool>, r#type: Option<String>, close_price: Option<f64>, close_price_as_of: Option<String>, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>, market_identifier_code: Option<String>, sector: Option<String>, industry: Option<String>, option_contract: Option<crate::models::OptionContract>) -> Security {
        Security {
            security_id,
            isin,
            cusip,
