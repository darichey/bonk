...
impl LinkSessionCraItemAddResult {
    ...
    pub fn new(item_id: String, accounts: Vec<crate::models::LinkSessionSuccessMetadataAccount>, institution: Option<crate::models::LinkSessionSuccessMetadataInstitution>) -> LinkSessionCraItemAddResult {
