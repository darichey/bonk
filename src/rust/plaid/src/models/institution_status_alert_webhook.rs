...
impl InstitutionStatusAlertWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, institution_id: String, institution_overall_success_rate: f64, environment: models::WebhookEnvironmentValues) -> InstitutionStatusAlertWebhook {
