...
pub struct InstitutionsGetRequest {
    ...
    pub options: Option<Box<models::InstitutionsGetRequestOptions>>,
}

impl InstitutionsGetRequest {
    /// InstitutionsGetRequest defines the request schema for `/institutions/get`
    pub fn new(count: i32, offset: i32, country_codes: Vec<models::CountryCode>) -> InstitutionsGetRequest {
