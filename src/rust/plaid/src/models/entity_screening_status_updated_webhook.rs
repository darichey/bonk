...
impl EntityScreeningStatusUpdatedWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, entity_screening_id: String, environment: models::WebhookEnvironmentValues) -> EntityScreeningStatusUpdatedWebhook {
