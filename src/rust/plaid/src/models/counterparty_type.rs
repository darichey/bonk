...
impl std::fmt::Display for CounterpartyType {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            ...
            Self::FinancialInstitution => write!(f, "financial_institution"),
            Self::PaymentApp => write!(f, "payment_app"),
            Self::Marketplace => write!(f, "marketplace"),
            Self::PaymentTerminal => write!(f, "payment_terminal"),
            Self::IncomeSource => write!(f, "income_source"),
        }
    }
}
