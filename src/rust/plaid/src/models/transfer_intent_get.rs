...
pub struct TransferIntentGet {
    ...
    pub failure_reason: Option<models::TransferIntentGetFailureReason>,
    #[serde(rename = "authorization_decision", deserialize_with = "Option::deserialize")]
    pub authorization_decision: Option<models::TransferIntentAuthorizationDecision>,
    #[serde(rename = "authorization_decision_rationale", deserialize_with = "Option::deserialize")]
    pub authorization_decision_rationale: Option<models::TransferAuthorizationDecisionRationale>,
...
impl TransferIntentGet {
    ...
    pub fn new(id: String, created: String, status: models::TransferIntentStatus, transfer_id: Option<String>, failure_reason: Option<models::TransferIntentGetFailureReason>, authorization_decision: Option<models::TransferIntentAuthorizationDecision>, authorization_decision_rationale: Option<models::TransferAuthorizationDecisionRationale>, origination_account_id: String, funding_account_id: String, amount: String, mode: models::TransferIntentCreateMode, user: models::TransferUserInResponse, description: String, iso_currency_code: String, guarantee_decision: Option<models::TransferAuthorizationGuaranteeDecision>, guarantee_decision_rationale: Option<models::TransferAuthorizationGuaranteeDecisionRationale>) -> TransferIntentGet {
        TransferIntentGet {
            id,
            created,
            status,
