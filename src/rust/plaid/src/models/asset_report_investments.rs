...
pub struct AssetReportInvestments {
    ...
    pub fees: Option<f64>,
    #[serde(rename = "type")]
    pub r#type: models::InvestmentTransactionType,
    #[serde(rename = "subtype")]
    pub subtype: models::InvestmentTransactionSubtype,
...
impl AssetReportInvestments {
    ...
    pub fn new(investment_transaction_id: String, account_id: String, security_id: Option<String>, date: String, name: String, quantity: f64, vested_quantity: f64, vested_value: f64, amount: f64, price: f64, fees: Option<f64>, r#type: models::InvestmentTransactionType, subtype: models::InvestmentTransactionSubtype, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>) -> AssetReportInvestments {
