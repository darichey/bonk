...
pub struct IncomeBreakdown {
    ...
    pub r#type: Option<models::IncomeBreakdownType>,
...
impl IncomeBreakdown {
    ...
    pub fn new(r#type: Option<models::IncomeBreakdownType>, rate: Option<f64>, hours: Option<f64>, total: Option<f64>) -> IncomeBreakdown {
        IncomeBreakdown {
            r#type,
            rate,
            hours,
