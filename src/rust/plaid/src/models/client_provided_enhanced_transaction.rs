...
pub struct ClientProvidedEnhancedTransaction {
    ...
    pub enhancements: models::Enhancements,
}

impl ClientProvidedEnhancedTransaction {
    /// A client-provided transaction that Plaid has enhanced.
    pub fn new(id: String, description: String, amount: f64, iso_currency_code: String, enhancements: models::Enhancements) -> ClientProvidedEnhancedTransaction {
