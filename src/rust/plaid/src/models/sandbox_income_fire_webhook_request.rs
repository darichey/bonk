...
pub struct SandboxIncomeFireWebhookRequest {
    ...
    pub webhook_code: models::SandboxIncomeWebhookFireRequestWebhookCode,
}
...
impl SandboxIncomeFireWebhookRequest {
    ...
    pub fn new(item_id: String, webhook: String, webhook_code: models::SandboxIncomeWebhookFireRequestWebhookCode) -> SandboxIncomeFireWebhookRequest {
