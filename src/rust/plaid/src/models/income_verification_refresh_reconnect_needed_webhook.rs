...
impl IncomeVerificationRefreshReconnectNeededWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, user_id: String, environment: crate::models::WebhookEnvironmentValues) -> IncomeVerificationRefreshReconnectNeededWebhook {
