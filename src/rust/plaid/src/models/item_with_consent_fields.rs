...
impl ItemWithConsentFields {
    ...
    pub fn new(item_id: String, webhook: Option<String>, error: Option<crate::models::PlaidError>, available_products: Vec<crate::models::Products>, billed_products: Vec<crate::models::Products>, consent_expiration_time: Option<String>, update_type: UpdateType) -> ItemWithConsentFields {
