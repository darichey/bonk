...
pub struct ItemWithConsentFields {
    ...
    pub consented_data_scopes: Option<Vec<models::ItemConsentedDataScope>>,
}

impl ItemWithConsentFields {
    /// Metadata about the Item
    pub fn new(item_id: String, webhook: Option<String>, error: Option<models::PlaidError>, available_products: Vec<models::Products>, billed_products: Vec<models::Products>, consent_expiration_time: Option<String>, update_type: UpdateType) -> ItemWithConsentFields {
