...
pub struct CraMonitoringInsightsItem {
    ...
    pub item_id: String,
    #[serde(rename = "status")]
    pub status: crate::models::MonitoringInsightsItemStatus,
    #[serde(rename = "insights", deserialize_with = "Option::deserialize")]
    pub insights: Option<crate::models::MonitoringInsights>,
}

impl CraMonitoringInsightsItem {
    /// An object representing a Monitoring Insights Item
    pub fn new(date_generated: String, item_id: String, status: crate::models::MonitoringInsightsItemStatus, insights: Option<crate::models::MonitoringInsights>) -> CraMonitoringInsightsItem {
