...
pub struct AccountsBalanceGetResponsePaymentRiskAssessment {
    ...
    pub risk_level: crate::models::BalancePlusRiskLevel,
    #[serde(rename = "attributes")]
    pub attributes: crate::models::BalancePlusAttributes,
    ...
    pub risk_reasons: Option<Vec<crate::models::RiskReason>>,
...
impl AccountsBalanceGetResponsePaymentRiskAssessment {
    ...
    pub fn new(risk_level: crate::models::BalancePlusRiskLevel, attributes: crate::models::BalancePlusAttributes, balance_last_updated: String, exceeds_balance_threshold: bool) -> AccountsBalanceGetResponsePaymentRiskAssessment {
        AccountsBalanceGetResponsePaymentRiskAssessment {
            risk_level,
            attributes,
            score: None,
