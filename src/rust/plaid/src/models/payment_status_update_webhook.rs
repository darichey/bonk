...
pub struct PaymentStatusUpdateWebhook {
    ...
    pub new_payment_status: models::PaymentInitiationPaymentStatus,
    #[serde(rename = "old_payment_status")]
    pub old_payment_status: models::PaymentInitiationPaymentStatus,
...
impl PaymentStatusUpdateWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, payment_id: String, new_payment_status: models::PaymentInitiationPaymentStatus, old_payment_status: models::PaymentInitiationPaymentStatus, original_reference: Option<String>, original_start_date: Option<String>, adjusted_start_date: Option<String>, timestamp: String, environment: models::WebhookEnvironmentValues) -> PaymentStatusUpdateWebhook {
