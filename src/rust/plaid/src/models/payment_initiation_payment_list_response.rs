...
pub struct PaymentInitiationPaymentListResponse {
    ...
    pub payments: Vec<models::PaymentInitiationPayment>,
...
impl PaymentInitiationPaymentListResponse {
    ...
    pub fn new(payments: Vec<models::PaymentInitiationPayment>, next_cursor: Option<String>, request_id: String) -> PaymentInitiationPaymentListResponse {
