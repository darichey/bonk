...
pub struct AssetReport {
    ...
    #[serde(rename = "user")]
    pub user: models::AssetReportUser,
    /// Data returned by Plaid about each of the Items included in the Asset Report.
    #[serde(rename = "items")]
    pub items: Vec<models::AssetReportItem>,
}

impl AssetReport {
    /// An object representing an Asset Report
    pub fn new(asset_report_id: String, client_report_id: Option<String>, date_generated: String, days_requested: f64, user: models::AssetReportUser, items: Vec<models::AssetReportItem>) -> AssetReport {
        AssetReport {
            asset_report_id,
            client_report_id,
            date_generated,
