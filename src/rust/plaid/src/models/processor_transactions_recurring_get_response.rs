...
impl ProcessorTransactionsRecurringGetResponse {
    /// ProcessorTransactionsRecurringGetResponse defines the response schema for `/processor/transactions/recurring/get`
    pub fn new(inflow_streams: Vec<models::TransactionStream>, outflow_streams: Vec<models::TransactionStream>, updated_datetime: String, request_id: String) -> ProcessorTransactionsRecurringGetResponse {
