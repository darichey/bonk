...
pub struct LinkTokenCreateRequestUserStatedIncomeSource {
    ...
    pub category: Option<models::UserStatedIncomeSourceCategory>,
    ...
    pub pay_type: Option<models::UserStatedIncomeSourcePayType>,
    #[serde(rename = "pay_frequency", skip_serializing_if = "Option::is_none")]
    pub pay_frequency: Option<models::UserStatedIncomeSourceFrequency>,
}
