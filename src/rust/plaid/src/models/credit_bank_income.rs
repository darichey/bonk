...
pub struct CreditBankIncome {
    ...
    pub items: Option<Vec<models::CreditBankIncomeItem>>,
    #[serde(rename = "bank_income_summary", skip_serializing_if = "Option::is_none")]
    pub bank_income_summary: Option<models::CreditBankIncomeSummary>,
    ...
    pub warnings: Option<Vec<models::CreditBankIncomeWarning>>,
}
