...
impl IndividualWatchlistProgram {
    ...
    pub fn new(id: String, created_at: String, is_rescanning_enabled: bool, lists_enabled: Vec<models::IndividualWatchlistCode>, name: String, name_sensitivity: models::ProgramNameSensitivity, audit_trail: models::WatchlistScreeningAuditTrail, is_archived: bool) -> IndividualWatchlistProgram {
