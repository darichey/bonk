...
impl RecurringTransferNullable {
    ...
    pub fn new(recurring_transfer_id: String, created: String, next_origination_date: Option<String>, r#type: crate::models::TransferType, amount: String, status: crate::models::TransferRecurringStatus, network: crate::models::TransferRecurringNetwork, origination_account_id: String, account_id: String, funding_account_id: String, iso_currency_code: String, description: String, transfer_ids: Vec<String>, user: crate::models::TransferUserInResponse, schedule: crate::models::TransferRecurringSchedule) -> RecurringTransferNullable {
