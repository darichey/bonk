...
pub struct RecurringTransferNullable {
    ...
    pub schedule: Box<models::TransferRecurringSchedule>,
}

impl RecurringTransferNullable {
    /// Represents a recurring transfer within the Transfers API.
    pub fn new(recurring_transfer_id: String, created: String, next_origination_date: Option<String>, r#type: models::TransferType, amount: String, status: models::TransferRecurringStatus, network: models::TransferRecurringNetwork, origination_account_id: String, account_id: String, funding_account_id: String, iso_currency_code: String, description: String, transfer_ids: Vec<String>, user: models::TransferUserInResponse, schedule: models::TransferRecurringSchedule) -> RecurringTransferNullable {
