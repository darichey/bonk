...
pub struct BaseReportAverageFlowInsights {
    ...
    pub total_amount: crate::models::CreditAmountWithCurrency,
}
...
impl BaseReportAverageFlowInsights {
    ...
    pub fn new(start_date: String, end_date: String, total_amount: crate::models::CreditAmountWithCurrency) -> BaseReportAverageFlowInsights {
