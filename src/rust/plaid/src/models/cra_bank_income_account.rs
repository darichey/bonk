...
pub struct CraBankIncomeAccount {
    ...
    pub metadata: Box<crate::models::CraBankIncomeAccountMetadata>,
...
impl CraBankIncomeAccount {
    ...
    pub fn new(mask: Option<String>, metadata: crate::models::CraBankIncomeAccountMetadata, name: String, official_name: Option<String>, subtype: crate::models::DepositoryAccountSubtype, r#type: crate::models::CreditBankIncomeAccountType, owners: Vec<crate::models::Owner>) -> CraBankIncomeAccount {
