...
pub struct WatchlistScreeningIndividualProgramListResponse {
    ...
    pub watchlist_programs: Vec<models::IndividualWatchlistProgram>,
...
impl WatchlistScreeningIndividualProgramListResponse {
    ...
    pub fn new(watchlist_programs: Vec<models::IndividualWatchlistProgram>, next_cursor: Option<String>, request_id: String) -> WatchlistScreeningIndividualProgramListResponse {
