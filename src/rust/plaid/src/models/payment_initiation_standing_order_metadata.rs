...
pub struct PaymentInitiationStandingOrderMetadata {
    ...
    pub valid_standing_order_intervals: Vec<models::PaymentScheduleInterval>,
}

impl PaymentInitiationStandingOrderMetadata {
    /// Metadata specifically related to valid Payment Initiation standing order configurations for the institution.
    pub fn new(supports_standing_order_end_date: bool, supports_standing_order_negative_execution_days: bool, valid_standing_order_intervals: Vec<models::PaymentScheduleInterval>) -> PaymentInitiationStandingOrderMetadata {
