...
impl WalletTransactionExecuteRequest {
    ...
    pub fn new(idempotency_key: String, wallet_id: String, counterparty: models::WalletTransactionCounterparty, amount: models::WalletTransactionAmount, reference: String) -> WalletTransactionExecuteRequest {
