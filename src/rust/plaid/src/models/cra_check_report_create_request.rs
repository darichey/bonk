...
impl CraCheckReportCreateRequest {
    ...
    pub fn new(user_token: String, webhook: String, days_requested: i32, consumer_report_permissible_purpose: models::ConsumerReportPermissiblePurpose) -> CraCheckReportCreateRequest {
