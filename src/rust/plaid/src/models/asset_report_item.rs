...
pub struct AssetReportItem {
    ...
    pub accounts: Vec<models::AccountAssets>,
}

impl AssetReportItem {
    /// A representation of an Item within an Asset Report.
    pub fn new(item_id: String, institution_name: String, institution_id: String, date_last_updated: String, accounts: Vec<models::AccountAssets>) -> AssetReportItem {
        AssetReportItem {
            item_id,
            institution_name,
            institution_id,
