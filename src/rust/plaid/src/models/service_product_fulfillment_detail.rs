...
pub struct ServiceProductFulfillmentDetail {
    ...
    pub service_product_fulfillment_identifier: models::ServiceProductFulfillmentIdentifier,
}

impl ServiceProductFulfillmentDetail {
    /// Documentation not found in the MISMO model viewer and not provided by Freddie Mac.
    pub fn new(vendor_order_identifier: Option<String>, service_product_fulfillment_identifier: models::ServiceProductFulfillmentIdentifier) -> ServiceProductFulfillmentDetail {
