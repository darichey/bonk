...
pub struct BankTransferEventListResponse {
    ...
    pub bank_transfer_events: Vec<models::BankTransferEvent>,
...
impl BankTransferEventListResponse {
    ...
    pub fn new(bank_transfer_events: Vec<models::BankTransferEvent>, request_id: String) -> BankTransferEventListResponse {
