...
impl WatchlistScreeningEntityListResponse {
    ...
    pub fn new(entity_watchlist_screenings: Vec<models::EntityWatchlistScreening>, next_cursor: Option<String>, request_id: String) -> WatchlistScreeningEntityListResponse {
