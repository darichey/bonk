...
pub struct Counterparty {
    ...
    #[serde(rename = "type")]
    pub r#type: models::CounterpartyType,
...
impl Counterparty {
    ...
    pub fn new(name: String, r#type: models::CounterpartyType, website: Option<String>, logo_url: Option<String>, phone_number: Option<String>) -> Counterparty {
        Counterparty {
            name,
            entity_id: None,
            r#type,
