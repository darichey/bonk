...
impl ProcessorRecurringTransactionsUpdateWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, account_id: String, environment: crate::models::WebhookEnvironmentValues) -> ProcessorRecurringTransactionsUpdateWebhook {
