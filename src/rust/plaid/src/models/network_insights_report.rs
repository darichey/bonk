...
pub struct NetworkInsightsReport {
    ...
    #[serde(rename = "items")]
    pub items: Vec<models::NetworkInsightsItem>,
}

impl NetworkInsightsReport {
    /// Contains data for the Network Insights Report.
    pub fn new(report_id: String, generated_time: String, network_attributes: serde_json::Value, items: Vec<models::NetworkInsightsItem>) -> NetworkInsightsReport {
