...
pub struct BankTransferEventListRequest {
    ...
    pub bank_transfer_type: Option<Option<models::BankTransferEventListBankTransferType>>,
    /// Filter events by event type.
    #[serde(rename = "event_types", skip_serializing_if = "Option::is_none")]
    pub event_types: Option<Vec<models::BankTransferEventType>>,
    ...
    pub direction: Option<Option<models::BankTransferEventListDirection>>,
}
