...
impl WatchlistScreeningEntityHitListResponse {
    ...
    pub fn new(entity_watchlist_screening_hits: Vec<crate::models::EntityWatchlistScreeningHit>, next_cursor: Option<String>, request_id: String) -> WatchlistScreeningEntityHitListResponse {
