...
pub struct LinkSessionResults {
    ...
    pub item_add_results: Vec<models::LinkSessionItemAddResult>,
    /// The set of Plaid Check Item adds for the Link session.
    #[serde(rename = "cra_item_add_results")]
    pub cra_item_add_results: Vec<models::LinkSessionCraItemAddResult>,
    /// The set of bank income verifications for the Link session.
    #[serde(rename = "bank_income_results")]
    pub bank_income_results: Vec<models::LinkSessionBankIncomeResult>,
    /// The set of payroll income verifications for the Link session.
    #[serde(rename = "payroll_income_results")]
    pub payroll_income_results: Vec<models::LinkSessionPayrollIncomeResult>,
    #[serde(rename = "document_income_results", deserialize_with = "Option::deserialize")]
    pub document_income_results: Option<Box<models::CreditSessionDocumentIncomeResult>>,
}

impl LinkSessionResults {
    /// The set of results for a Link session.
    pub fn new(item_add_results: Vec<models::LinkSessionItemAddResult>, cra_item_add_results: Vec<models::LinkSessionCraItemAddResult>, bank_income_results: Vec<models::LinkSessionBankIncomeResult>, payroll_income_results: Vec<models::LinkSessionPayrollIncomeResult>, document_income_results: Option<models::CreditSessionDocumentIncomeResult>) -> LinkSessionResults {
        LinkSessionResults {
            item_add_results,
