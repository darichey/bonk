...
impl ProcessorTokenWebhookUpdate {
    ...
    pub fn new(webhook_type: String, webhook_code: String, account_id: String, new_webhook_url: String, environment: models::WebhookEnvironmentValues) -> ProcessorTokenWebhookUpdate {
