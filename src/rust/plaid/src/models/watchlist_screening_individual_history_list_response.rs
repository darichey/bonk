...
impl WatchlistScreeningIndividualHistoryListResponse {
    ...
    pub fn new(watchlist_screenings: Vec<models::WatchlistScreeningIndividual>, next_cursor: Option<String>, request_id: String) -> WatchlistScreeningIndividualHistoryListResponse {
