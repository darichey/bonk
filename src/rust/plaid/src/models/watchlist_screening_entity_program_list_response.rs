...
impl WatchlistScreeningEntityProgramListResponse {
    ...
    pub fn new(entity_watchlist_programs: Vec<crate::models::EntityWatchlistProgram>, next_cursor: Option<String>, request_id: String) -> WatchlistScreeningEntityProgramListResponse {
