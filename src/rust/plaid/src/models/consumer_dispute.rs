...
pub struct ConsumerDispute {
    ...
    pub category: crate::models::ConsumerDisputeCategory,
...
impl ConsumerDispute {
    ...
    pub fn new(consumer_dispute_id: String, dispute_field_create_date: String, category: crate::models::ConsumerDisputeCategory, statement: String) -> ConsumerDispute {
        ConsumerDispute {
            consumer_dispute_id,
