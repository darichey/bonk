...
pub struct LinkTokenCreateRequestIncomeVerification {
    ...
    pub income_source_types: Option<Vec<models::IncomeVerificationSourceType>>,
    #[serde(rename = "bank_income", skip_serializing_if = "Option::is_none")]
    pub bank_income: Option<Box<models::LinkTokenCreateRequestIncomeVerificationBankIncome>>,
    #[serde(rename = "payroll_income", skip_serializing_if = "Option::is_none")]
    pub payroll_income: Option<Box<models::LinkTokenCreateRequestIncomeVerificationPayrollIncome>>,
    /// A list of user stated income sources
    #[serde(rename = "stated_income_sources", skip_serializing_if = "Option::is_none")]
    pub stated_income_sources: Option<Vec<models::LinkTokenCreateRequestUserStatedIncomeSource>>,
}
