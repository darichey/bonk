...
pub struct PartnerEndCustomerOAuthStatusUpdatedWebhook {
    ...
    #[serde(rename = "status")]
    pub status: models::PartnerEndCustomerOAuthStatusUpdatedValues,
}
...
impl PartnerEndCustomerOAuthStatusUpdatedWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, end_customer_client_id: String, environment: models::WebhookEnvironmentValues, institution_id: String, institution_name: String, status: models::PartnerEndCustomerOAuthStatusUpdatedValues) -> PartnerEndCustomerOAuthStatusUpdatedWebhook {
