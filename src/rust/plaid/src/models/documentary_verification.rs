...
pub struct DocumentaryVerification {
    ...
    pub documents: Vec<models::DocumentaryVerificationDocument>,
}
...
impl DocumentaryVerification {
    ...
    pub fn new(status: String, documents: Vec<models::DocumentaryVerificationDocument>) -> DocumentaryVerification {
