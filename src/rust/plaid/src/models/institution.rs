...
pub struct Institution {
    ...
    pub status: Option<Option<models::InstitutionStatus>>,
    ...
    pub auth_metadata: Option<Option<models::AuthMetadata>>,
}

impl Institution {
    /// Details relating to a specific financial institution
    pub fn new(institution_id: String, name: String, products: Vec<models::Products>, country_codes: Vec<models::CountryCode>, routing_numbers: Vec<String>, oauth: bool) -> Institution {
        Institution {
            institution_id,
            name,
            products,
