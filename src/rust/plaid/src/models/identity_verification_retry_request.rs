...
pub struct IdentityVerificationRetryRequest {
    ...
    pub user: Option<Option<crate::models::IdentityVerificationRequestUser>>,
...
impl IdentityVerificationRetryRequest {
    ...
    pub fn new(client_user_id: String, template_id: String, strategy: crate::models::Strategy) -> IdentityVerificationRetryRequest {
