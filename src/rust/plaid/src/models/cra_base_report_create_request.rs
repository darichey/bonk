...
impl CraBaseReportCreateRequest {
    ...
    pub fn new(user_token: String, days_requested: i32, webhook: Option<String>, consumer_report_permissible_purpose: crate::models::ConsumerReportPermissiblePurpose) -> CraBaseReportCreateRequest {
