...
pub struct CraNetworkInsightsReport {
    ...
    #[serde(rename = "items")]
    pub items: Vec<crate::models::CraNetworkInsightsItem>,
}

impl CraNetworkInsightsReport {
    /// Contains data for the CRA Network Attributes Report.
    pub fn new(report_id: String, generated_time: String, network_attributes: serde_json::Value, items: Vec<crate::models::CraNetworkInsightsItem>) -> CraNetworkInsightsReport {
