...
pub struct IdentityVerificationUserData {
    ...
    pub address: Option<models::IdentityVerificationUserAddress>,
...
impl IdentityVerificationUserData {
    ...
    pub fn new(date_of_birth: Option<String>, ip_address: Option<String>, email_address: Option<String>, name: Option<models::IdentityVerificationResponseUserName>, address: Option<models::IdentityVerificationUserAddress>, id_number: Option<models::UserIdNumber>) -> IdentityVerificationUserData {
