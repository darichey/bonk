...
impl EntityWatchlistProgram {
    ...
    pub fn new(id: String, created_at: String, is_rescanning_enabled: bool, lists_enabled: Vec<models::EntityWatchlistCode>, name: String, name_sensitivity: models::ProgramNameSensitivity, audit_trail: models::WatchlistScreeningAuditTrail, is_archived: bool) -> EntityWatchlistProgram {
