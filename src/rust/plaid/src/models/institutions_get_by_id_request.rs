...
pub struct InstitutionsGetByIdRequest {
    ...
    pub options: Option<Box<models::InstitutionsGetByIdRequestOptions>>,
}

impl InstitutionsGetByIdRequest {
    /// InstitutionsGetByIdRequest defines the request schema for `/institutions/get_by_id`
    pub fn new(institution_id: String, country_codes: Vec<models::CountryCode>) -> InstitutionsGetByIdRequest {
