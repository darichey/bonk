...
pub struct CraMonitoringInsightsGetRequest {
    ...
    pub consumer_report_permissible_purpose: models::MonitoringConsumerReportPermissiblePurpose,
}
...
impl CraMonitoringInsightsGetRequest {
    ...
    pub fn new(user_token: String, consumer_report_permissible_purpose: models::MonitoringConsumerReportPermissiblePurpose) -> CraMonitoringInsightsGetRequest {
