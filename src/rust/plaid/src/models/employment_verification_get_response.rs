...
pub struct EmploymentVerificationGetResponse {
    ...
    pub employments: Vec<models::EmploymentVerification>,
...
impl EmploymentVerificationGetResponse {
    ...
    pub fn new(employments: Vec<models::EmploymentVerification>, request_id: String) -> EmploymentVerificationGetResponse {
