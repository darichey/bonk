...
pub struct Enhancements {
    ...
    pub counterparties: Option<Vec<models::Counterparty>>,
}

impl Enhancements {
    /// A grouping of the Plaid produced transaction enhancement fields.
    pub fn new(payment_channel: models::PaymentChannel, category_id: Option<String>, category: Vec<String>, location: models::Location) -> Enhancements {
        Enhancements {
            merchant_name: None,
            website: None,
            logo_url: None,
