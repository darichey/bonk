...
pub struct TransactionsSyncResponse {
    ...
    pub transactions_update_status: crate::models::TransactionsUpdateStatus,
...
impl TransactionsSyncResponse {
    ...
    pub fn new(transactions_update_status: crate::models::TransactionsUpdateStatus, accounts: Vec<crate::models::AccountBase>, added: Vec<crate::models::Transaction>, modified: Vec<crate::models::Transaction>, removed: Vec<crate::models::RemovedTransaction>, next_cursor: String, has_more: bool, request_id: String) -> TransactionsSyncResponse {
        TransactionsSyncResponse {
