...
pub struct TransferRecurringCreateRequest {
    ...
    pub device: Option<models::TransferDevice>,
}

impl TransferRecurringCreateRequest {
    /// Defines the request schema for `/transfer/recurring/create`
    pub fn new(access_token: String, idempotency_key: String, account_id: String, r#type: models::TransferType, network: models::TransferRecurringNetwork, amount: String, description: String, schedule: models::TransferRecurringSchedule, user: models::TransferUserInRequest) -> TransferRecurringCreateRequest {
