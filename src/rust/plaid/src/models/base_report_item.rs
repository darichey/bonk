...
impl BaseReportItem {
    ...
    pub fn new(institution_name: String, institution_id: String, date_last_updated: String, item_id: String, accounts: Vec<crate::models::BaseReportAccount>) -> BaseReportItem {
        BaseReportItem {
            institution_name,
            institution_id,
            date_last_updated,
