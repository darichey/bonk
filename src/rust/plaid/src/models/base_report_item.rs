...
pub struct BaseReportItem {
    ...
    pub accounts: Vec<models::BaseReportAccount>,
}

impl BaseReportItem {
    /// A representation of an Item within a Base Report.
    pub fn new(institution_name: String, institution_id: String, date_last_updated: String, item_id: String, accounts: Vec<models::BaseReportAccount>) -> BaseReportItem {
        BaseReportItem {
            institution_name,
            institution_id,
            date_last_updated,
