...
impl std::fmt::Display for TransferEventType {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            ...
            Self::SweepPeriodPending => write!(f, "sweep.pending"),
            Self::SweepPeriodPosted => write!(f, "sweep.posted"),
            Self::SweepPeriodSettled => write!(f, "sweep.settled"),
            Self::SweepPeriodReturned => write!(f, "sweep.returned"),
            Self::SweepPeriodFailed => write!(f, "sweep.failed"),
            Self::RefundPeriodPending => write!(f, "refund.pending"),
            Self::RefundPeriodCancelled => write!(f, "refund.cancelled"),
            Self::RefundPeriodFailed => write!(f, "refund.failed"),
            Self::RefundPeriodPosted => write!(f, "refund.posted"),
            Self::RefundPeriodSettled => write!(f, "refund.settled"),
            Self::RefundPeriodReturned => write!(f, "refund.returned"),
            Self::RefundPeriodSwept => write!(f, "refund.swept"),
            Self::RefundPeriodReturnSwept => write!(f, "refund.return_swept"),
        }
    }
}
