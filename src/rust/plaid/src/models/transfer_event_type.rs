...
impl ToString for TransferEventType {
    fn to_string(&self) -> String {
        match self {
            ...
            Self::FundsAvailable => String::from("funds_available"),
            ...
            Self::RefundPeriodPending => String::from("refund.pending"),
            Self::RefundPeriodCancelled => String::from("refund.cancelled"),
            Self::RefundPeriodFailed => String::from("refund.failed"),
            Self::RefundPeriodPosted => String::from("refund.posted"),
            Self::RefundPeriodSettled => String::from("refund.settled"),
            Self::RefundPeriodReturned => String::from("refund.returned"),
            Self::RefundPeriodSwept => String::from("refund.swept"),
            Self::RefundPeriodReturnSwept => String::from("refund.return_swept"),
        }
    }
}
