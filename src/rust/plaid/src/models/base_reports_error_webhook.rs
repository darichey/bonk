...
impl BaseReportsErrorWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, error: Option<models::PlaidError>, user_id: String, environment: models::WebhookEnvironmentValues) -> BaseReportsErrorWebhook {
