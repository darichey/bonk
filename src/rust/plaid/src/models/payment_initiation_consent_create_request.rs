...
pub struct PaymentInitiationConsentCreateRequest {
    ...
    pub scopes: Option<Vec<crate::models::PaymentInitiationConsentScope>>,
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<crate::models::PaymentInitiationConsentType>,
    ...
    pub payer_details: Option<Option<crate::models::PaymentInitiationConsentPayerDetails>>,
}
...
impl PaymentInitiationConsentCreateRequest {
    ...
    pub fn new(recipient_id: String, reference: String, constraints: crate::models::PaymentInitiationConsentConstraints) -> PaymentInitiationConsentCreateRequest {
