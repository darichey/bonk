...
impl InvestmentsHistoricalUpdateWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, item_id: String, new_investments_transactions: f64, canceled_investments_transactions: f64, environment: models::WebhookEnvironmentValues) -> InvestmentsHistoricalUpdateWebhook {
