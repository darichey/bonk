...
impl ProcessorTransactionsRemovedWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, removed_transactions: Vec<String>, account_id: String, environment: models::WebhookEnvironmentValues) -> ProcessorTransactionsRemovedWebhook {
