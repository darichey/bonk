...
impl std::fmt::Display for CreditBankIncomeCategory {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            ...
            Self::TransferFromApplication => write!(f, "TRANSFER_FROM_APPLICATION"),
            Self::TaxRefund => write!(f, "TAX_REFUND"),
            Self::BenefitOther => write!(f, "BENEFIT_OTHER"),
