...
pub struct CraBankIncomeTransaction {
    ...
    pub bonus_type: Option<Option<models::CraBankIncomeBonusType>>,
}

impl CraBankIncomeTransaction {
    /// The transactions data for the end user's income source(s).
    pub fn new(transaction_id: String, amount: f64, date: String, original_description: Option<String>, pending: bool, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>) -> CraBankIncomeTransaction {
