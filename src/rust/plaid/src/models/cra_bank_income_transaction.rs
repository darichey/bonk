...
pub struct CraBankIncomeTransaction {
    ...
    #[serde(rename = "bonus_type", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub bonus_type: Option<Option<crate::models::CraBankIncomeBonusType>>,
}

impl CraBankIncomeTransaction {
    /// The transactions data for the end user's income source(s).
    pub fn new(transaction_id: String, amount: f32, date: String, original_description: Option<String>, pending: bool, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>) -> CraBankIncomeTransaction {
