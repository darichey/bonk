...
pub struct CreditBankEmploymentItem {
    ...
    pub bank_employments: Vec<models::CreditBankEmployment>,
    /// The Item's accounts that have Bank Employment data.
    #[serde(rename = "bank_employment_accounts")]
    pub bank_employment_accounts: Vec<models::CreditBankIncomeAccount>,
}

impl CreditBankEmploymentItem {
    /// The details and metadata for an end user's Item.
    pub fn new(item_id: String, last_updated_time: String, institution_id: String, institution_name: String, bank_employments: Vec<models::CreditBankEmployment>, bank_employment_accounts: Vec<models::CreditBankIncomeAccount>) -> CreditBankEmploymentItem {
