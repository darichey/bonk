...
pub struct PartnerCustomerOAuthInstitutionsGetResponse {
    ...
    pub flowdown_status: Option<models::PartnerEndCustomerFlowdownStatus>,
    #[serde(rename = "questionnaire_status", skip_serializing_if = "Option::is_none")]
    pub questionnaire_status: Option<models::PartnerEndCustomerQuestionnaireStatus>,
    ...
    pub institutions: Option<Vec<models::PartnerEndCustomerOAuthInstitution>>,
