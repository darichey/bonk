...
impl AssetsErrorWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, error: Option<models::PlaidError>, asset_report_id: String, environment: models::WebhookEnvironmentValues) -> AssetsErrorWebhook {
        AssetsErrorWebhook {
            webhook_type,
            webhook_code,
            error,
