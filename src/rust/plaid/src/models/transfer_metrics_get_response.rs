...
pub struct TransferMetricsGetResponse {
    ...
    pub return_rates: Option<Option<crate::models::TransferMetricsGetReturnRates>>,
    #[serde(rename = "authorization_usage", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub authorization_usage: Option<Option<crate::models::TransferMetricsGetAuthorizationUsage>>,
}
