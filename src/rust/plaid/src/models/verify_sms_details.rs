...
pub struct VerifySmsDetails {
    #[serde(rename = "status")]
    pub status: crate::models::VerifySmsDetailsStatus,
    ...
    pub verifications: Vec<crate::models::SmsVerification>,
}

impl VerifySmsDetails {
    /// Additional information for the `verify_sms` step.
    pub fn new(status: crate::models::VerifySmsDetailsStatus, verifications: Vec<crate::models::SmsVerification>) -> VerifySmsDetails {
        VerifySmsDetails {
            status,
            verifications,
        }
