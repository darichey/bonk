...
pub struct CreditBankEmploymentGetResponse {
    ...
    pub bank_employment_reports: Vec<models::CreditBankEmploymentReport>,
...
impl CreditBankEmploymentGetResponse {
    ...
    pub fn new(bank_employment_reports: Vec<models::CreditBankEmploymentReport>, request_id: String) -> CreditBankEmploymentGetResponse {
