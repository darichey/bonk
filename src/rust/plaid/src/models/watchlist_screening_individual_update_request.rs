...
pub struct WatchlistScreeningIndividualUpdateRequest {
    ...
    pub search_terms: Option<Option<Box<crate::models::UpdateIndividualScreeningRequestSearchTerms>>>,
    ...
    pub reset_fields: Option<Option<Vec<crate::models::WatchlistScreeningIndividualUpdateRequestResettableField>>>,
}
