...
pub enum PrismFirstDetectVersion {
    #[serde(rename = "3")]
    Variant3,
    #[serde(rename = "null")]
    Null,
...
impl std::fmt::Display for PrismFirstDetectVersion {
...
impl Default for PrismFirstDetectVersion {
    fn default() -> PrismFirstDetectVersion {
        Self::Variant3
    }
}
