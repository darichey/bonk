...
impl WalletTransactionGetResponse {
    ...
    pub fn new(transaction_id: String, wallet_id: String, reference: String, r#type: Type, amount: models::WalletTransactionAmount, counterparty: models::WalletTransactionCounterparty, status: models::WalletTransactionStatus, created_at: String, last_status_update: String, request_id: String) -> WalletTransactionGetResponse {
