...
impl WalletTransactionGetResponse {
    ...
    pub fn new(transaction_id: String, wallet_id: String, reference: String, r#type: Type, amount: crate::models::WalletTransactionAmount, counterparty: crate::models::WalletTransactionCounterparty, status: crate::models::WalletTransactionStatus, created_at: String, last_status_update: String, request_id: String) -> WalletTransactionGetResponse {
        WalletTransactionGetResponse {
            transaction_id,
            wallet_id,
            reference,
