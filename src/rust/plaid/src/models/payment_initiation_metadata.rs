...
impl PaymentInitiationMetadata {
    ...
    pub fn new(supports_international_payments: bool, supports_sepa_instant: bool, maximum_payment_amount: ::std::collections::HashMap<String, String>, supports_refund_details: bool, standing_order_metadata: Option<crate::models::PaymentInitiationStandingOrderMetadata>, supports_payment_consents: bool) -> PaymentInitiationMetadata {
