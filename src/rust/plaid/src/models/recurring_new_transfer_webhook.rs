...
impl RecurringNewTransferWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, recurring_transfer_id: String, transfer_id: String, environment: models::WebhookEnvironmentValues) -> RecurringNewTransferWebhook {
