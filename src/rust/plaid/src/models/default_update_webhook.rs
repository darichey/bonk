...
impl DefaultUpdateWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, new_transactions: f64, item_id: String, environment: models::WebhookEnvironmentValues) -> DefaultUpdateWebhook {
