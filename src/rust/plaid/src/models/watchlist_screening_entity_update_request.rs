...
pub struct WatchlistScreeningEntityUpdateRequest {
    ...
    pub search_terms: Option<Option<Box<models::UpdateEntityScreeningRequestSearchTerms>>>,
    ...
    pub reset_fields: Option<Option<Vec<models::WatchlistScreeningEntityUpdateRequestResettableField>>>,
}
