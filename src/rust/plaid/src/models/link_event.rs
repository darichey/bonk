...
pub struct LinkEvent {
    ...
    pub event_metadata: crate::models::LinkEventMetadata,
}

impl LinkEvent {
    /// An event that occurred while the user was going through Link
    pub fn new(event_name: String, timestamp: String, event_id: String, event_metadata: crate::models::LinkEventMetadata) -> LinkEvent {
        LinkEvent {
            event_name,
            timestamp,
            event_id,
