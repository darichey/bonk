...
pub struct CraLoanRegister {
    ...
    pub payment_schedule: models::CraLoanPaymentSchedule,
    ...
    pub opened_with_status: models::CraLoanOpenedStatus,
    ...
    pub application: Option<models::CraLoanRegisterApplication>,
}

impl CraLoanRegister {
    /// Contains loan data to register.
    pub fn new(user_token: String, loan_id: String, r#type: models::CraLoanType, payment_schedule: models::CraLoanPaymentSchedule, opened_date: String, opened_with_status: models::CraLoanOpenedStatus) -> CraLoanRegister {
        CraLoanRegister {
            user_token,
            loan_id,
            r#type,
