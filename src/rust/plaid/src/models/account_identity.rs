...
impl AccountIdentity {
    ...
    pub fn new(account_id: String, balances: crate::models::AccountBalance, mask: Option<String>, name: String, official_name: Option<String>, r#type: crate::models::AccountType, subtype: Option<crate::models::AccountSubtype>, owners: Vec<crate::models::Owner>) -> AccountIdentity {
        AccountIdentity {
            account_id,
            balances,
            mask,
