...
pub struct LinkProfileEligibilityCheckRequest {
    ...
    #[serde(rename = "user")]
    pub user: models::LinkProfileEligibilityCheckUser,
}
...
impl LinkProfileEligibilityCheckRequest {
    ...
    pub fn new(link_session_id: String, user: models::LinkProfileEligibilityCheckUser) -> LinkProfileEligibilityCheckRequest {
