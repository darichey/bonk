...
pub struct CreditBankEmployment {
    ...
    pub employer: Box<models::CreditBankEmployer>,
...
impl CreditBankEmployment {
    ...
    pub fn new(bank_employment_id: String, account_id: String, employer: models::CreditBankEmployer, latest_deposit_date: String, earliest_deposit_date: String) -> CreditBankEmployment {
