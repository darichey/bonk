...
pub struct AccountIdentityMatchScore {
    ...
    pub verification_insights: Option<crate::models::AccountVerificationInsights>,
    ...
    pub holder_category: Option<Option<crate::models::AccountHolderCategory>>,
...
impl AccountIdentityMatchScore {
    ...
    pub fn new(account_id: String, balances: crate::models::AccountBalance, mask: Option<String>, name: String, official_name: Option<String>, r#type: crate::models::AccountType, subtype: Option<crate::models::AccountSubtype>) -> AccountIdentityMatchScore {
