...
pub struct AccountIdentityMatchScore {
    ...
    pub legal_name: Option<Option<models::NameMatchScore>>,
    #[serde(rename = "phone_number", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub phone_number: Option<Option<models::PhoneNumberMatchScore>>,
    #[serde(rename = "email_address", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub email_address: Option<Option<models::EmailAddressMatchScore>>,
    #[serde(rename = "address", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub address: Option<Option<models::AddressMatchScore>>,
}

impl AccountIdentityMatchScore {
    /// Identity match scores for an account
    pub fn new(account_id: String, balances: models::AccountBalance, mask: Option<String>, name: String, official_name: Option<String>, r#type: models::AccountType, subtype: Option<models::AccountSubtype>) -> AccountIdentityMatchScore {
