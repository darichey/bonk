...
pub struct CraBankIncomeSummary {
    ...
    pub historical_annual_gross_income: Option<Vec<crate::models::CreditAmountWithCurrency>>,
    ...
    pub historical_annual_income: Option<Vec<crate::models::CreditAmountWithCurrency>>,
    ...
    pub forecasted_annual_income: Option<Vec<crate::models::CreditAmountWithCurrency>>,
