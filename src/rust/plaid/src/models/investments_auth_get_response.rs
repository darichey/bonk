...
pub struct InvestmentsAuthGetResponse {
    ...
    pub data_sources: crate::models::InvestmentsAuthDataSources,
    #[serde(rename = "item")]
...
impl InvestmentsAuthGetResponse {
    ...
    pub fn new(accounts: Vec<crate::models::AccountBase>, holdings: Vec<crate::models::Holding>, securities: Vec<crate::models::Security>, owners: Vec<crate::models::InvestmentsAuthOwner>, numbers: crate::models::InvestmentsAuthGetNumbers, data_sources: crate::models::InvestmentsAuthDataSources, item: crate::models::Item, request_id: String) -> InvestmentsAuthGetResponse {
        InvestmentsAuthGetResponse {
            accounts,
            holdings,
            securities,
