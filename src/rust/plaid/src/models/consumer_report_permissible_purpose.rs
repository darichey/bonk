...
impl std::fmt::Display for ConsumerReportPermissiblePurpose {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::AccountReviewCredit => write!(f, "ACCOUNT_REVIEW_CREDIT"),
            Self::AccountReviewNonCredit => write!(f, "ACCOUNT_REVIEW_NON_CREDIT"),
            Self::Employment => write!(f, "EMPLOYMENT"),
            Self::ExtensionOfCredit => write!(f, "EXTENSION_OF_CREDIT"),
            Self::LegitimateBusinessNeedTenantScreening => write!(f, "LEGITIMATE_BUSINESS_NEED_TENANT_SCREENING"),
            Self::LegitimateBusinessNeedOther => write!(f, "LEGITIMATE_BUSINESS_NEED_OTHER"),
            Self::WrittenInstructionPrequalification => write!(f, "WRITTEN_INSTRUCTION_PREQUALIFICATION"),
            Self::WrittenInstructionOther => write!(f, "WRITTEN_INSTRUCTION_OTHER"),
        }
    }
}
