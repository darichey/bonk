...
pub struct LinkTokenCreateRequest {
    ...
    #[serde(rename = "user")]
    pub user: Box<models::LinkTokenCreateRequestUser>,
    ...
    pub required_if_supported_products: Option<Option<Vec<models::Products>>>,
    ...
    pub optional_products: Option<Option<Vec<models::Products>>>,
    ...
    pub additional_consented_products: Option<Option<Vec<models::Products>>>,
    ...
    pub institution_data: Option<Box<models::LinkTokenCreateInstitutionData>>,
    #[serde(rename = "card_switch", skip_serializing_if = "Option::is_none")]
    pub card_switch: Option<Box<models::LinkTokenCreateCardSwitch>>,
    #[serde(rename = "account_filters", skip_serializing_if = "Option::is_none")]
    pub account_filters: Option<models::LinkTokenAccountFilters>,
    #[serde(rename = "eu_config", skip_serializing_if = "Option::is_none")]
    pub eu_config: Option<Box<models::LinkTokenEuConfig>>,
    ...
    pub payment_configuration: Option<Box<models::LinkTokenCreateRequestPaymentConfiguration>>,
    #[serde(rename = "payment_initiation", skip_serializing_if = "Option::is_none")]
    pub payment_initiation: Option<Box<models::LinkTokenCreateRequestPaymentInitiation>>,
    #[serde(rename = "deposit_switch", skip_serializing_if = "Option::is_none")]
    pub deposit_switch: Option<Box<models::LinkTokenCreateRequestDepositSwitch>>,
    #[serde(rename = "employment", skip_serializing_if = "Option::is_none")]
    pub employment: Option<Box<models::LinkTokenCreateRequestEmployment>>,
    #[serde(rename = "income_verification", skip_serializing_if = "Option::is_none")]
    pub income_verification: Option<Box<models::LinkTokenCreateRequestIncomeVerification>>,
    #[serde(rename = "base_report", skip_serializing_if = "Option::is_none")]
    pub base_report: Option<Box<models::LinkTokenCreateRequestBaseReport>>,
    #[serde(rename = "credit_partner_insights", skip_serializing_if = "Option::is_none")]
    pub credit_partner_insights: Option<Box<models::LinkTokenCreateRequestCreditPartnerInsights>>,
    #[serde(rename = "cra_options", skip_serializing_if = "Option::is_none")]
    pub cra_options: Option<Box<models::LinkTokenCreateRequestCraOptions>>,
    #[serde(rename = "consumer_report_permissible_purpose", skip_serializing_if = "Option::is_none")]
    pub consumer_report_permissible_purpose: Option<Box<models::ConsumerReportPermissiblePurpose>>,
    #[serde(rename = "auth", skip_serializing_if = "Option::is_none")]
    pub auth: Option<Box<models::LinkTokenCreateRequestAuth>>,
    #[serde(rename = "transfer", skip_serializing_if = "Option::is_none")]
    pub transfer: Option<Box<models::LinkTokenCreateRequestTransfer>>,
    #[serde(rename = "update", skip_serializing_if = "Option::is_none")]
    pub update: Option<Box<models::LinkTokenCreateRequestUpdate>>,
    #[serde(rename = "identity_verification", skip_serializing_if = "Option::is_none")]
    pub identity_verification: Option<Box<models::LinkTokenCreateRequestIdentityVerification>>,
    #[serde(rename = "statements", skip_serializing_if = "Option::is_none")]
    pub statements: Option<Box<models::LinkTokenCreateRequestStatements>>,
    ...
    pub investments: Option<Box<models::LinkTokenInvestments>>,
    #[serde(rename = "investments_auth", skip_serializing_if = "Option::is_none")]
    pub investments_auth: Option<Box<models::LinkTokenInvestmentsAuth>>,
    #[serde(rename = "hosted_link", skip_serializing_if = "Option::is_none")]
    pub hosted_link: Option<models::LinkTokenCreateHostedLink>,
    #[serde(rename = "transactions", skip_serializing_if = "Option::is_none")]
    pub transactions: Option<Box<models::LinkTokenTransactions>>,
    ...
    pub identity: Option<Box<models::LinkTokenCreateIdentity>>,
...
impl LinkTokenCreateRequest {
    ...
    pub fn new(client_name: String, language: String, country_codes: Vec<models::CountryCode>, user: models::LinkTokenCreateRequestUser) -> LinkTokenCreateRequest {
