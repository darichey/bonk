...
pub struct LinkSessionSuccessMetadata {
    ...
    pub institution: Option<Option<Box<crate::models::LinkSessionSuccessMetadataInstitution>>>,
    ...
    pub accounts: Option<Vec<crate::models::LinkSessionSuccessMetadataAccount>>,
    ...
    pub transfer_status: Option<Option<crate::models::LinkSessionSuccessMetadataTransferStatus>>,
}
