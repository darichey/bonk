...
impl Enrichments {
    ...
    pub fn new(counterparties: Vec<crate::models::Counterparty>, location: crate::models::Location, logo_url: Option<String>, merchant_name: Option<String>, payment_channel: crate::models::PaymentChannel, personal_finance_category: Option<crate::models::PersonalFinanceCategory>, personal_finance_category_icon_url: String, website: Option<String>) -> Enrichments {
        Enrichments {
            check_number: None,
            counterparties,
            entity_id: None,
