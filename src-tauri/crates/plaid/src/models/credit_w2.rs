...
impl CreditW2 {
    ...
    pub fn new(document_metadata: crate::models::CreditDocumentMetadata, document_id: String, employer: crate::models::CreditPayStubEmployer, employee: crate::models::CreditPayStubEmployee, tax_year: Option<String>, employer_id_number: Option<String>, wages_tips_other_comp: Option<String>, federal_income_tax_withheld: Option<String>, social_security_wages: Option<String>, social_security_tax_withheld: Option<String>, medicare_wages_and_tips: Option<String>, medicare_tax_withheld: Option<String>, social_security_tips: Option<String>, allocated_tips: Option<String>, box_9: Option<String>, dependent_care_benefits: Option<String>, nonqualified_plans: Option<String>, box_12: Vec<crate::models::W2Box12>, statutory_employee: Option<String>, retirement_plan: Option<String>, third_party_sick_pay: Option<String>, other: Option<String>, state_and_local_wages: Vec<crate::models::W2StateAndLocalWages>) -> CreditW2 {
        CreditW2 {
            document_metadata,
            document_id,
            employer,
