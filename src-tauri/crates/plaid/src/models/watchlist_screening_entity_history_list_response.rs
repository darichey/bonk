...
impl WatchlistScreeningEntityHistoryListResponse {
    ...
    pub fn new(entity_watchlist_screenings: Vec<crate::models::EntityWatchlistScreening>, next_cursor: Option<String>, request_id: String) -> WatchlistScreeningEntityHistoryListResponse {
