...
impl EntityScreeningStatusUpdatedWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, screening_id: String, environment: crate::models::WebhookEnvironmentValues) -> EntityScreeningStatusUpdatedWebhook {
