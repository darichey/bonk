...
impl WatchlistScreeningIndividualUpdateResponse {
    ...
    pub fn new(id: String, search_terms: crate::models::WatchlistScreeningSearchTerms, assignee: Option<String>, status: crate::models::WatchlistScreeningStatus, client_user_id: Option<String>, audit_trail: crate::models::WatchlistScreeningAuditTrail, request_id: String) -> WatchlistScreeningIndividualUpdateResponse {
