...
pub struct LinkTokenCreateRequestUserAddress {
...
impl LinkTokenCreateRequestUserAddress {
    pub fn new(street: String, city: String, country: String) -> LinkTokenCreateRequestUserAddress {
        LinkTokenCreateRequestUserAddress {
            street,
            street2: None,
            city,
            region: None,
