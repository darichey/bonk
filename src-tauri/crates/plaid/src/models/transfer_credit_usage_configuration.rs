...
pub struct TransferCreditUsageConfiguration {
    ...
    pub sec_codes: Vec<crate::models::CreditAchClass>,
}
...
impl TransferCreditUsageConfiguration {
    ...
    pub fn new(expected_frequency: crate::models::OriginatorExpectedTransferFrequency, expected_highest_amount: String, expected_average_amount: String, expected_monthly_amount: String, sec_codes: Vec<crate::models::CreditAchClass>) -> TransferCreditUsageConfiguration {
