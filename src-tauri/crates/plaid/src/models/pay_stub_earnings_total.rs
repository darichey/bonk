...
impl PayStubEarningsTotal {
    ...
    pub fn new(current_amount: Option<f64>, hours: Option<f32>, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>, ytd_amount: Option<f64>) -> PayStubEarningsTotal {
