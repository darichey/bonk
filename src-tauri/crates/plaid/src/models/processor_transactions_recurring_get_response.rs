...
impl ProcessorTransactionsRecurringGetResponse {
    ...
    pub fn new(inflow_streams: Vec<crate::models::TransactionStream>, outflow_streams: Vec<crate::models::TransactionStream>, updated_datetime: String, request_id: String) -> ProcessorTransactionsRecurringGetResponse {
