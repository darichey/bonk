...
impl TransferRecurringCreateRequest {
    ...
    pub fn new(access_token: String, idempotency_key: String, account_id: String, r#type: crate::models::TransferType, network: crate::models::TransferNetwork, amount: String, description: String, schedule: crate::models::TransferRecurringSchedule, user: crate::models::TransferUserInRequest) -> TransferRecurringCreateRequest {
