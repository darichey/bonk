...
pub struct TransferDiligenceSubmitRequest {
    ...
    pub originator_diligence: Box<crate::models::TransferOriginatorDiligence>,
}

impl TransferDiligenceSubmitRequest {
    /// Defines the request schema for `/transfer/diligence/submit`
    pub fn new(originator_client_id: String, originator_diligence: crate::models::TransferOriginatorDiligence) -> TransferDiligenceSubmitRequest {
