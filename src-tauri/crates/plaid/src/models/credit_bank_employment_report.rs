...
impl CreditBankEmploymentReport {
    ...
    pub fn new(bank_employment_report_id: String, generated_time: String, days_requested: i32, items: Vec<crate::models::CreditBankEmploymentItem>, warnings: Vec<crate::models::CreditBankEmploymentWarning>) -> CreditBankEmploymentReport {
