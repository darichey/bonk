...
pub struct BeaconUserData {
    ...
    pub id_number: crate::models::BeaconUserIdNumber,
...
impl BeaconUserData {
    ...
    pub fn new(date_of_birth: String, name: crate::models::BeaconUserName, address: crate::models::BeaconUserAddress, email_address: Option<String>, phone_number: Option<String>, id_number: crate::models::BeaconUserIdNumber, ip_address: Option<String>) -> BeaconUserData {
        BeaconUserData {
            date_of_birth,
            name,
            address,
