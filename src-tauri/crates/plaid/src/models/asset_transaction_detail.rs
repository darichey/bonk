...
impl AssetTransactionDetail {
    ...
    pub fn new(asset_transaction_unique_identifier: String, asset_transaction_amount: f32, asset_transaction_date: String, asset_transaction_post_date: String, asset_transaction_type: crate::models::AssetTransactionType, asset_transaction_paid_by_name: Option<String>, asset_transaction_type_additional_description: Option<String>, asset_transaction_category_type: Option<crate::models::AssetTransactionCategoryType>, financial_institution_transaction_identifier: Option<String>) -> AssetTransactionDetail {
