...
impl ClientProvidedTransaction {
    ...
    pub fn new(id: String, description: String, amount: f64, direction: crate::models::EnrichTransactionDirection, iso_currency_code: String) -> ClientProvidedTransaction {
