...
pub struct SandboxTransferLedgerDepositSimulateRequest {
    ...
    pub event_type: crate::models::TransferLedgerSweepSimulateEventType,
...
impl SandboxTransferLedgerDepositSimulateRequest {
    ...
    pub fn new(sweep_id: String, event_type: crate::models::TransferLedgerSweepSimulateEventType) -> SandboxTransferLedgerDepositSimulateRequest {
